...
return {
	...
	["thjiyi"]="祭仪",
	[":thjiyi"]="出牌阶段，你可以指定一名有手牌的其他角色，该角色需展示一张手牌，若该牌为锦囊牌，你须选择一项：交给其一张锦囊牌或让其摸一张牌；若不为锦囊牌，你获得此牌，每阶段限一次。",
	["@thjiyi"]="请展示一张手牌",
	["thqiyuan"]="祈愿",
...
4. 弃置两张红桃牌并令一名其他角色摸一张牌，然后该角色将其武将牌翻面 ",
	...
	["#thxiangang"]="%from 使用技能【%arg】防止了此伤害",
...
2. 上述方法无法正常使用的手牌，可通过点击“<font color=green><b>筹策</b></font>”按钮使用。",
	["$ThChouce"]="%from 将 %card 的目标改为了 %to",
	["thzhanshi"]="占筮",
	...
	["#yuki008"]="法界之火",
	["yuki008"]="圣白莲",--雪 - 空 - 3血
	["designer:yuki008"]="幻桜落 | Codeby:Slob",
...
每阶段限一次。",
	["thlianxue"]="恋血",
	[":thlianxue"]="<b>觉醒技</b>，回合开始阶段开始时，若你的装备区有坐骑牌，你须摸两张牌或回复1点体力，然后减少1点体力上限并获得技能“<b>狂骨</b>”。",
	["thlianxue:draw"]="摸两张牌",
	["thlianxue:recover"]="回复1点体力",
	["#ThLianxueWake"]="%from 的装备区有坐骑牌，触发觉醒技“%arg”",
	["@lianxue"]="恋血",
