...
2.跳过你此回合的出牌阶段。\
你每选择一项，获得1枚“法灯”标记。",
	["thbaota:3"]="你可以发动【宝塔】跳过摸牌阶段",
	["thbaota:4"]="你可以发动【宝塔】跳过出牌阶段",
	["thweiguang"]="威光",
...
你每选择一项，须先弃置1枚“法灯”标记，每项每回合限一次。",
	...
	["cv:tsuki002"]="暂无",
	["thjinguo"]="禁果",
	[":thjinguo"]="出牌阶段，你可以展示一张红桃手牌并指定一名已受伤的其他角色，该角色须选择一项：\
1.令你弃置该牌并获得其两张手牌（不足则全部获得），然后该角色回复1点体力；\
2.令你获得以下技能直到回合结束：你可将红桃基本牌当【乐不思蜀】使用。\
每阶段限一次。",
	["thjinguo:give"]="令对方获得技能",
	["thjinguo:discard"]="弃置该牌并令其获得两张手牌",
	["thshixue"]="嗜血",
	[":thshixue"]="<b>觉醒技</b>，回合开始阶段开始时，若你的装备区有坐骑牌，你须弃置两张牌或失去1点体力，然后减少1点体力上限并获得技能“狂骨”。",
	["#ThShixueWake"]="%from 的装备区有坐骑牌，触发觉醒技【%arg】",
