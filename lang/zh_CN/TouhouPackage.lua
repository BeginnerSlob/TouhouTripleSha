...
否则，该角色获得这张“网”，然后摸一张牌。",
	...
	["$thbian2"]="不惜身命，悔之晚矣。",
	["thguihang"]="归航",
	[":thguihang"]="当一名角色进入濒死状态时，你可以展示其一张手牌，若为红色，该角色须弃置之并回复1点体力。",
	["@thguihang"]="请展示一张手牌",
	["$thguihang1"]="阳寿未尽，怎可渡汝？",
	["$thguihang2"]="可惜身命，乃可为哉。",
	["thwujian"]="无间",
	[":thwujian"]="出牌阶段，你可以弃置一张牌并指定你攻击范围内的一名其他角色，直到你的下回合开始，当该角色计算与令一名角色的距离时，始终+1，每阶段限一次。",
	["@wujian"]="无间",
	...
	["thyuchang"]="羽裳",
	[":thyuchang"]="<b>锁定技</b>，你使用具雷电伤害的【杀】时无距离限制；你的草花【杀】均视为具雷电伤害的【杀】。",
...
4. 弃置两张红桃牌并令一名其他角色摸一张牌，然后该角色将其武将牌翻面 ",
	...
	["thzheyin"]="蛰隐",
	[":thzheyin"]="出牌阶段，你可以将一张手牌面朝上置于你的武将牌上，每阶段限一次。你不能成为与这张牌花色相同牌的目标，直到你的下回合开始；你的回合开始时，你须弃置这张牌。",
	["thzheyinpile"]="蛰隐牌",
	...
	["cv:hana012"]="暂无",
	["thguaitan"]="怪谈",
	[":thguaitan"]="每当你对目标角色造成一次伤害后，选择一种牌的类别，该角色的下一个回合不能使用或者打出所选类别的牌。",
