...
return {
	...
	["#zhanghe"] = "白樱之华",
	["zhanghe"] = "桂雏菊",
	["illustrator:zhanghe"] = "正体不明",
	["qiaobian"] = "曼才",
	[":qiaobian"] = "你可以弃置一张手牌跳过你的一个阶段（回合开始和回合结束阶段除外），若以此法跳过摸牌阶段，你获得其他至多两名角色各一张手牌；若以此法跳过出牌阶段，你可以将场上的一张牌移动到另一名角色区域内的相应位置。\
