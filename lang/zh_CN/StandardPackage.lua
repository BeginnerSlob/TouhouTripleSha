...
武器特效：<b>锁定技</b>，你在出牌阶段内使用【杀】时无次数限制。",
	...
	[":DoubleSword"] = "装备牌·武器\
攻击范围：２\
武器特效：当你使用【杀】指定一名特殊属性不同的角色为目标后，你可以令其选择一项：弃置一张手牌，或令你摸一张牌。",
	["double-sword-card"] = "%src 发动了绯想剑特效，您必须弃置一张手牌或让 %src 摸一张牌",
	["DoubleSword:yes"] = "您可以让对方选择自弃置一牌或让您摸一张牌",

	["QinggangSword"] = "楼观剑",
	[":QinggangSword"] = "装备牌·武器\
攻击范围：２\
武器特效：<b>锁定技</b>，当你使用【杀】指定一名角色为目标后，你无视其防具。\◆你使用【杀】指定A为目标后触发【楼观剑】无视A的防具，效果持续到该【杀】被【闪】抵消或A受到的伤害被防止或A受到的伤害进行伤害结算计算出最终的伤害值时为止。",

	["Blade"] = "离魂之镰",
	[":Blade"] = "装备牌·武器\
攻击范围：３\
武器特效：当你使用的【杀】被【闪】抵消时，你可以对相同的目标再使用一张【杀】（无距离限制）。",
	["blade-slash"] = "您可以对 %src 使用一张【杀】发动离魂之镰的追杀效果",
	["#BladeUse"] = "%from 使用了【离魂之镰】，对 %to 使用了一张【杀】",
