...
--wind
	...
	["ikfansheng"] = "返生",
	[":ikfansheng"] = "限定技，当你处于濒死状态时，你可以摸四张牌，并将体力回复至X点（X为场上的势力数），然后将你的人物牌翻面。",
...
--bloom
	...
	["ikmice"] = "谜策",
	[":ikmice"] = "出牌阶段限一次，你可以将所有手牌当除【荒波暴流】外的一张非延时类锦囊牌使用。",
	["ikzhiyuxi"] = "智愚",
...
--snow
	...
	["iknilan"] = "霓岚",
	[":iknilan"] = "锁定技，当你失去一次装备区里的装备牌时；或弃牌阶段结束时，若你在此阶段弃置了两张或更多的手牌，你须获得1枚“疾雷”标记。一名角色的结束阶段开始时，你须弃置1枚“疾雷”标记，然后选择一项：<br />1. 对距离为1的一名角色造成1点雷电伤害；<br />2. 视为对一名其他角色使用一张无视距离的具雷电伤害的【杀】；<br />3. 摸一张牌，然后弃置一张手牌。<br />你须重复此流程，直到你没有“疾雷”标记为止。",
	["iknilan:damage"] = "对距离为1的一名角色造成1点雷电伤害",
	["iknilan:slash"] = "视为对一名其他角色使用一张无视距离的具雷电伤害的【杀】",
	["iknilan:draw"] = "摸一张牌，然后弃置一张手牌",
