...
--luna
	...
	["#luna028"] = "雅馨的剑姬",
	["luna028"] = "琪露蒂•夏普",--月 - 幻 - 3血
	["ikqingpo"] = "青魄",
	[":ikqingpo"] = "一名其他角色的回合开始时，若你已受伤，你可与其拼点。若你赢，该角色跳过此回合的出牌阶段；否则该角色计算与你的距离时，无视除你之外的其他角色及场上的坐骑牌，直到回合结束。",
	["ikmeichu"] = "魅楚",
	[":ikmeichu"] = "当你成为【杀】的目标时，你可以令一名其他角色选择一项：交给你一张【闪】；或该角色也成为此【杀】的目标。",
	["ikmeichu-invoke"] = "你可以发动“魅楚”<br/> <b>操作提示</b>: 选择除此【杀】使用者外的一名其他角色→点击确定<br/>",
	["@ikmeichu-give"] = "请交给 %src 一张【闪】",
