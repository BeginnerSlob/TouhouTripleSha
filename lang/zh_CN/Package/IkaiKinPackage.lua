...
--bloom
	...
	["ikhuaan"] = "华岸",
	[":ikhuaan"] = "每当你的黑色基本牌因弃置而进入弃牌堆时，你可以无视距离将之当做【枯羽华庭】置于一名其他角色的判定区里。",
...
--snow
	...
	["ikzhongqu"] = "终曲",
	[":ikzhongqu"] = "你每使用【杀】造成一次伤害后，可以令受到该伤害的角色将其人物牌翻面，然后选择一项：令该角色摸等同于其体力值数量的牌；或摸等同于其已损失的体力值数量的牌。",
	["drawHp"] = "摸等同于其体力值数量的牌",
...
--luna
	...
	["ikmiaoyu"] = "描欲",
	[":ikmiaoyu"] = "摸牌阶段摸牌时，你可以额外摸X张牌（X为场上的势力数），若如此做，你于本回合内使用的牌不能指定其他角色为目标。",
