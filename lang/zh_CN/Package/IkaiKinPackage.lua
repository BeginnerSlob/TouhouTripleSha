...
--bloom
	...
	["ikpiaohu"] = "飘忽",
	[":ikpiaohu"] = "你的回合外，当你攻击范围内的一名角色成为【杀】的目标时，你可弃置一张非基本牌，或将该角色与你的人物牌横置，若如此做，将此【杀】转移给你。",
	...
	["illustrator:bloom020"] = "kamyuu",
	["ikmice"] = "谜策",
	[":ikmice"] = "阶段技。你可以将所有手牌当一张非延时类锦囊牌使用。",
	["ikzhiyuxi"] = "智愚",
	[":ikzhiyuxi"] = "每当你受到一次伤害后，你可以摸一张牌，然后展示全部的手牌，若颜色均相同，伤害来源须弃置一张手牌。",
...
--snow
	...
	["#snow056"] = "苍炎的迹境",
	["snow056"] = "维拉•札•伊格妮法丝特",--雪 - 空 - 4血
	["&snow056"] = "维拉",
	["designer:snow056"] = "凌风自舞",
	["illustrator:snow056"] = "天之有",
	["ikguimo"] = "轨墨",
	[":ikguimo"] = "每当你需要使用或打出一张基本牌时，你可以与一名手牌数少于你的角色交换手牌，若如此做，视为你使用或打出了此牌，每回合限一次。",
	["@ikguimo"] = "你发动了“轨墨”，请与一名手牌数少于你的角色交换手牌",
	["ikguimo_slash"] = "轨墨出杀",
	["ikguimo_saveself"] = "轨墨自救",
	...
	["ikshenchi"] = "神敕",
	[":ikshenchi"] = "结束阶段开始时，你可以令至多X名角色依次摸一张牌，然后令这些角色依次将一张牌置于牌堆顶（若你拥有技能“繁祟”，X为你的体力值，否则为你的体力上限）。",
	["@ikshenchi"] = "你可以发动“神敕”",
...
--luna
	...
	["illustrator:luna010"] = "A4",
	["iklvdong"] = "律动",
	[":iklvdong"] = "阶段技。你可以与一名其他角色拼点。若你赢，你无视与该角色的距离及其装备区的防具牌；你可以对该角色使用任意数量的【杀】；若你没赢，你不能使用【杀】直到回合结束。",
	["ikguozai"] = "过载",
	...
	["ikdanbo"] = "澹泊",
	[":ikdanbo"] = "摸牌阶段摸牌时，你可以额外摸X张牌（X为场上的势力数），若如此做，你于本回合内使用的牌不能指定其他角色为目标。",
