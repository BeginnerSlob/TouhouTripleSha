...
--snow
	...
	["illustrator:snow056"] = "創-taro",
	["ikmoling"] = "墨灵",
	[":ikmoling"] = "每当你需要使用或打出一张基本牌时，你可以与一名手牌数少于你的角色交换手牌，若如此做，视为你使用或打出了此牌，每回合限一次。",
	["@ikmoling"] = "你发动了“墨灵”，请与一名手牌数少于你的角色交换手牌",
	["ikmoling_slash"] = "墨灵出杀",
	["ikmoling_saveself"] = "墨灵自救",
