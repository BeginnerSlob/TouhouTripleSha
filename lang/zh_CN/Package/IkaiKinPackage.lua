...
--wind
	...
	["ikxinchao"] = "心抄",
	[":ikxinchao"] = "出牌阶段限一次，你可以观看牌堆顶的三张牌，然后展示其中任意数量的红桃牌并获得之，将其余的以任意顺序置于牌堆顶。",
	["ikshangshi"] = "殇逝",
	...
	["ikzangyu"] = "葬谕",
	[":ikzangyu"] = "出牌阶段限一次，你可以令一名其他角色与你同时展示一张手牌：若你展示的是【杀】且该角色展示的不是【闪】，你弃置此【杀】并对其造成1点伤害；若你展示的不是【杀】且该角色展示的是【闪】，你弃置你展示的牌并获得其一张牌。",
	["ikshakuang"] = "歃狂",
...
--bloom
	...
	["ikbingyan"] = "冰焰",
	[":ikbingyan"] = "出牌阶段限一次，你可以弃置至少一张手牌，令一名其他角色选择一项：弃置一张与你所弃置牌类别均不同的手牌；或该角色将人物牌翻面并摸等同于你弃牌数的牌。",
