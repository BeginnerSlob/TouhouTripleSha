...
--wind
	...
	["@ikliqi-slash"] = "请打出一张【杀】以响应 %src 的“励气”",
	...
	["#IkYuxiResult"] = "%from 的预悉结果：%arg 上 %arg2 下",
...
--bloom
	...
	["@iklianbao-card"] = "是否发动“敛宝”",
	["~iklianbao"] = "选择 1-2 名其他角色→点击确定按钮。",

	["#bloom005"] = "高岭之花",
	["bloom005"] = "葵喜美",--花 - 空 - 4血
	["ikluoyi"] = "裸衣",
	[":ikluoyi"] = "你可以跳过摸牌阶段，并亮出牌堆顶的三张牌，然后获得其中的基本牌、武器牌和【碎月绮幕】，再将其余的牌置入弃牌堆，若如此做，你因执行【杀】或【碎月绮幕】的效果而造成的伤害+1，直到你的下回合开始。",
	["#IkLuoyiBuff"] = "%from 真空出马，%to 鼻血狂喷，受到的伤害从 %arg 点上升至 %arg2 点",
...
你每选择一项，视为对一名其他角色使用一张【杀】。",
	["@ikxunyu1"] = "跳过该回合的判定阶段和摸牌阶段，视为对一名其他角色使用了一张【杀】",
	["@ikxunyu2"] = "跳过该回合出牌阶段并弃置一张非锦囊牌，视为对一名其他角色使用了一张【杀】",
	["~ikxunyu1"] = "选择一名其他角色→点击确定",
	["~ikxunyu2"] = "选择一张非锦囊牌→选择一名其他角色→点击确定",
	...
	["@ikzhaihun"] = "宅魂",
	["#IkZhaihunDiscard"] = "%from 的“%arg2”技能被触发，需要弃掉 %arg 张牌";
	...
	["#IkYushenNoWolf"] = "%from “<font color=\"yellow\">御神</font>”拼点赢，由于 %to 攻击范围内没有其他角色，结算中止",
	["ikjieming"] = "节命",
	[":ikjieming"] = "每当你受到一次伤害后，可令一名角色将手牌补至等同于其体力上限的张数（至多补至五张）。",
	["@ikjieming"] = "请选择“节命”的目标",
	["~ikjieming"] = "选择一名角色→点击确定",
...
--snow
	...
	["#IkJiyuanExtraRecover"] = "雪势力的 %to 戳中了 %from 的萌点，触发了“%arg”，额外回复 <font color=yellow>1</font> 点体力",
	...
	["@IkQinghuaDiscard"] = "你可以弃置一张 %arg 花色的牌发动“青华”",
	...
	["@ikliangban"] = "您可以发动技能“良坂”",
	["~ikliangban"] = "选择一名其他角色→点击确定",
	...
	["~ikshenen"] = "选择需要交出的手牌→选择一名其他角色→点击确定",
	["ikdimeng"] = "缔盟",
	...
	["@ikzhihui-card"] = "请弃置一张红桃手牌来转移伤害",
	["~ikzhihui"] = "选择一张红桃手牌→选择一名其他角色→点击确定",
	["ikchiqiu"] = "赤秋",
...
--luna
	...
	["@ikwushuang-slash-1"] = "天下无双的 %src 与你决斗，你必须打出两张【杀】",
	["@ikwushuang-slash-2"] = "天下无双的 %src 与你决斗，请你再打出一张【杀】",
	...
	["@ikleiji"] = "令一名角色判定，若结果为黑桃，你对该角色造成2点雷电伤害",
	["~ikleiji"] = "选择一名角色→点击确定",
	["iktianshi"] = "天势",
	[":iktianshi"] = "在一名角色的判定牌生效前，你可以用一张黑色牌替换之。",
	["@iktianshi-card"] = "你可以发动“%dest”修改 %src 的 %arg 判定",
	["~iktianshi"] = "选择一张黑色牌→点击确定",
	["ikyuji"] = "御姬",
	[":ikyuji"] = "主公技，其他月势力角色的出牌段限一次，该角色可以交给你一张【闪】或黑色手牌。",
	["ikyujiv"] = "御姬",
	[":ikyujiv"] = "出牌阶段，你可以将一张【闪】或黑色手牌交给主公，每阶段限一次。",
	...
	["ikbengying"] = "崩影",
	[":ikbengying"] = "你死亡时，可以令杀死你的角色进行X次判定，每有一次判定结果为黑桃2~9，该角色受到3点无来源的雷电伤害（X为你的牌数）。",
