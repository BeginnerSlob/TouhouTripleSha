...
--snow
	...
	["ikbiju:skip"] = "跳过弃牌阶段",
	["ikpojian"] = "破茧",
	[":ikpojian"] = "觉醒技。结束阶段开始时，若你于此回合使用了不少于四张非装备牌，你须减少1点体力上限，并选择一项：回复1点体力或摸一张牌，然后获得技能“青华”（阶段技。你可以令一名其他角色展示一张手牌，然后你可以弃置一张花色相同的牌，若如此做，该角色须弃置其展示的手牌，然后你可以与其各回复1点体力。）。",
	["ikpojian:recover"] = "回复1点体力",
	["ikpojian:draw"] = "摸一张牌",
	["#IkPojianWake"] = "%from 于此回合使用了 %arg 张非装备牌，触发“%arg2”觉醒",
	["ikqinghua"] = "青华",
	[":ikqinghua"] = "阶段技。你可以令一名其他角色展示一张手牌，然后你可以弃置一张花色相同的牌，若如此做，该角色须弃置其展示的手牌，然后你可以与其各回复1点体力。",
