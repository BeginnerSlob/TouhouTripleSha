...
--wind
	...
	["ikshenai"] = "神爱",
	[":ikshenai"] = "出牌阶段，你可以将至少一张手牌交给一名其他角色，然后此阶段内你不能再以此法交给该角色手牌。若你于此阶段内发动“神爱”交出的牌数量首次达到两张或更多，你可以视为使用任意一张基本牌（以此法使用的【杀】或【酒】计入使用次数限制）。",
	["ikxinqi"] = "心契",
	[":ikxinqi"] = "君主技。当你需要使用或打出【杀】时，你可以令其他风势力角色打出一张【杀】，视为由你使用或打出。",
...
--bloom
	...
	["ikzhimen"] = "智门",
	[":ikzhimen"] = "限定技。当一张延时类锦囊牌置入弃牌堆前，你可以将之置入一名角色的判定区。",
	...
	["iktiandu"] = "天妒",
	[":iktiandu"] = "在你的判定牌生效后，你可以将之交给一名角色。",
	["ikyumeng"] = "羽梦",
	[":ikyumeng"] = "每当你受到1点伤害后，你可以摸两张牌，然后你可以将至多两张手牌交给一至两名其他角色。",
...
--snow
	...
	["ikzhiheng"] = "制衡",
	[":ikzhiheng"] = "阶段技。你可以弃置任意张牌，然后摸等量的牌，若你以此法弃置的牌中包括所有手牌，你多摸一张牌。",
	["ikjiyuan"] = "济援",
	[":ikjiyuan"] = "君主技。其他雪势力角色对其自己使用【桃】时，若其体力值大于你，则该角色可以改为令你回复1点体力，然后其摸一张牌。",
	...
	["ikbiju"] = "闭居",
	[":ikbiju"] = "锁定技。弃牌阶段开始时，若你未于出牌阶段内使用过颜色不同的牌或出牌阶段被跳过，你的手牌上限于此回合内+4。",
	["ikbiju:draw"] = "摸一张牌",
	["ikbiju:skip"] = "跳过弃牌阶段",
	["ikpojian"] = "破茧",
	[":ikpojian"] = "结束阶段开始时，若你于出牌阶段内使用过四种花色或三种类别的牌，则你可以移动场上的一张牌。",
...
--luna
	...
	["ikwudi"] = "武帝",
	[":ikwudi"] = "阶段技。你可以将两张相同颜色的手牌当【碎月绮斗】使用。",
