...
local t = {
	...
	["iron_armor"] = "火鼠裘",
	[":iron_armor"] = "装备牌·防具<br /><b>防具技能</b>：锁定技，你不能成为【灼狱业焰】、【血凤涅烟】和具火焰伤害的【杀】的目标。",
	...
	["breastplate"] = "御灵札",
	[":breastplate"] = "装备牌·防具<br /><b>防具技能</b>：每当你受到伤害时，若该伤害不小于X点，你可以防止此伤害，然后将【御灵札】弃置（X为你的体力值）。",
	...
	["drowning"] = "荒波暴流",
	[":drowning"] = "锦囊牌<br /><b>时机</b>：出牌阶段<br /><b>目标</b>：所有其他角色<br /><b>效果</b>：每名目标角色需令你弃置其装备区的一张牌，否则受到由你造成的1点伤害。",
