...
return {
	...
	--["~hana018"]="铭志，天地...不仁...",
	["thliuzhen"]="六震",
	[":thliuzhen"]="出牌阶段限一次，当你使用【杀】指定目标后，可以选择任意名不为该【杀】目标的其他角色，该【杀】在结算后置入弃牌堆时，你获得之并无视距离对你所选的角色使用，其中每有一名角色使用【闪】抵消了该【杀】的效果，你须弃置一张牌或失去1点体力。",
	["@thliuzhen"]="你可以发动“六震”",
	...
	["thtianchan"]="天禅",
	[":thtianchan"]="主公技，当你处于濒死状态时，其他花势力的角色可以将黑桃牌当【桃】使用。",
	["thtianchanv"]="天禅",
