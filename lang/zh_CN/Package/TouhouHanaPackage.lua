...
return {
	...
	["cv:hana010"] = "暂无",
	["thzheyin"] = "蛰隐",
	[":thzheyin"] = "当你成为基本牌的目标时，你可以取消你，若你的体力值为1，这张牌可以是锦囊牌。每阶段限一次。",
	["thyingdeng"] = "萤灯",
	...
	["cv:hana018"] = "暂无",
	["thliuzhen"] = "六震",
	[":thliuzhen"] = "当你于出牌阶段使用【杀】指定目标后，可以选择至少一名不为该【杀】目标的其他角色，此【杀】在结算后置入弃牌堆时，你无视距离对这些角色使用此【杀】，每当抵消一次此【杀】的效果，你须弃置一张牌或失去1点体力。每阶段限一次。",
	["@thliuzhen"] = "你可以发动“六震”",
