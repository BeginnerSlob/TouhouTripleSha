...
return {
	...
	["cv:kami001"]="暂无",
	["thkexing"]="客星",
	[":thkexing"]="准备阶段开始时，你可以从牌堆顶亮出X张牌（X为存活角色数量的一半，向上取整且至多为4），将其中任意数量的非锦囊牌以任意顺序置于牌堆底，然后将其余的牌置入弃牌堆。<br />※双击置入弃牌堆的牌，然后点击确定。",
	["thshenfeng"]="神风",
	[":thshenfeng"]="出牌阶段限一次，你可将两张相同颜色的牌交给一名体力值比你多的角色，然后该角色须对其距离为1的由你指定的一名角色造成1点伤害。",
	["thkaihai"]="开海",
	...
	["cv:kami002"]="暂无",
	["thjihui"]="极辉",
	[":thjihui"]="准备阶段开始时，你可选择一项“气象”，效果持续到你的下回合开始。你不能选择你上回合所选择的“气象”。<br />“烈日”：所有角色每次受到的火焰伤害+1。<br />“风雨”：所有角色计算与其他角色的距离时，始终-1。<br />“黄砂”：所有角色每次受到多于1点的伤害时，防止多余的伤害。<br />“昙天”：所有角色可将红桃花色的【闪】当【桃】使用。<br />“浓雾”：所有角色每使用【杀】对与其距离1以内的角色造成一次伤害后，回复1点体力。",
	["@jhlieri"]="烈日",
	["@jhfengyu"]="风雨",
	["@jhhuangsha"]="黄砂",
	["@jhtantian"]="昙天",
	...
	["thhuangyi"]="皇仪",
	[":thhuangyi"]="觉醒技，“千狱”发动后，准备阶段开始时，若你的体力上限大于X，你须将体力上限减少至X，并摸等同于减少数量的牌，然后回复1点体力，并失去技能“狂魔”（X为你游戏开始时的体力上限）。",
	...
	["designer:kami006"]="幻桜落 | Codeby:Slob",
	["illustrator:kami006"]="正体不明",
	["cv:kami006"]="暂无",
	["thpanghun"]="彷魂",
	...
	["#thpanghun-fil"]="彷魂",
	["thjingwu"]="镜悟",
	[":thjingwu"]="出牌阶段限一次，你可以展示一张黑色锦囊牌，然后弃置场上的一张牌。",
	["thlunyu"]="轮狱",
	[":thlunyu"]="连舞技，当一张你不为其使用的目标（或之一）的牌置入弃牌堆时，你将这张牌置于牌堆顶，然后此阶段结束时你从牌堆底摸一张牌。",
...
--连舞技：每当你的一个技能发动或触发时，若此时你所有的除了连舞技外的游戏开始时便拥有的技能都已在当前回合内发动或触发，则直到回合结束，你可以发动一次连舞技。连舞技无法被其他角色获得。
	...
	["thyoushang"]="诱殇",
	[":thyoushang"]="若你拥有技能“满咲”，每当你的非黑桃牌对目标角色造成伤害时，你可以防止此伤害，并令该角色减少1点体力上限，然后获得1枚“桜咲”标记。",
	["thyouya"]="幽雅",
	...
	["cv:kami009"]="暂无",
	["thyuxin"]="愈心",
	[":thyuxin"]="摸牌阶段开始时，你可弃置一张牌并放弃摸牌，改为从牌堆顶亮出两张牌并获得之，若这两张牌均为红色，你可以指定一名角色并令其回复1点体力。",
	["@thyuxin"]="你可以发动“愈心”",
	...
	["cv:kami010"]="暂无",
	["thrangdeng"]="禳灯",
	[":thrangdeng"]="锁定技，出牌阶段开始时，你须选择一项：依次将至多三张与你人物牌上的任何一张牌点数都不相同的手牌面朝上置于你的人物牌上，称为“灯”；或弃置一张手牌。你的人物牌上每有一种花色的“灯”，你获得相应的技能：红桃“闭月”；黑桃“濛雾”；方块“沉红”；梅花“疾步”。",
	["thrangdengpile"]="灯",
	...
	["thlingyun"]="灵殒",
	[":thlingyun"]="出牌阶段，若你不拥有相应技能，你可以弃置一张牌，并获得该技能，视为使用以下一张牌：<br />1.【绯想镜诗】－“崩坏”；<br />2.【碎月绮斗】－“散灵”；<br />3.【妙手探云】－“心殇”；<br />4.【赤雾锁魂】－“禁恋”。",
	["thzhaoai"]="朝霭",
	...
	["cv:kami012"]="暂无",
	["thwunan"]="五难",
	[":thwunan"]="每当一名其他角色：<br />1. 使用一张【神惠雨降】或【竹曲谜宝】时<br />2. 于濒死状态回复体力后，若其体力值不小于1<br />3. 受到一次火焰伤害后<br />4. 发动【净琉璃镜】使用或打出一张【闪】时<br />5. 使用【杀】对没有手牌的角色造成伤害时<br />你可以弃置一张手牌，然后回复1点体力并弃置该角色的一张手牌。",
	...
	["cv:kami015"]="暂无",
	["thzhizun"]="至尊",
	[":thzhizun"]="准备阶段或结束阶段开始时，你可选择一项：改变一名其他角色的势力属性；或获得一项技能（你只能以此法获得“心契”、“唤卫”、“济援”、“御姬”、“华袛”、“颂威”、“春度”或“舞华”，且无法获得场上其他存活角色拥有的以上技能）。",
	...
	["thsiqiang"]="死枪",
	[":thsiqiang"]="限定技，出牌阶段，你可以选择一名其他角色，若如此做，该角色不能使用或打出【杀】、【闪】或【三粒天滴】，直到回合结束。",
	["thjiefu"]="戒符",
	...
	["#story002"]="梦想天生",
	["story002"]="博丽灵梦",--神 - 幻 - 3血
	["designer:story002"]="幻桜落 | Codeby:Slob",
	...
	["thchayin"]="刹印",
	[":thsiqiang"]="准备阶段开始时，你可以弃置一张手牌，然后获得场上的一张花色相同的牌。",
	["thxuanyan"]="玄衍",
	[":thjiefu"]="锁定技，每当你受到多余1点的伤害时，防止多余的伤害；每当你进入濒死状态时或你的人物牌翻面时，你摸一张牌；你的技能不能被无效且不会失去。",
	
	["#story003"]="巫祖",
	["story003"]="博丽灵梦",--神 - 幻 - 3血
	["designer:story003"]="幻桜落 | Codeby:Slob",
	...
	[":thjiefu"]="锁定技，每当你受到多余1点的伤害时，防止多余的伤害；每当你进入濒死状态时或你的人物牌翻面时，你摸一张牌；你的技能不能被无效且不会失去。",
	["thshenghuan"]="圣幻",
	[":thjiefu"]="出牌阶段，你可将防具牌当【酒】、武器牌当【幽瞳占略】、坐骑牌当【绯想镜诗】使用。",
	["thshenmie"]="神灭",
	[":thjiefu"]="你可以将两张花色相同的手牌当【杀】或【碎月绮斗】使用或打出；当你使用【杀】时，你可以额外指定至多两个目标。",
	["thhongdao"]="鸿道",
	[":thjiefu"]="锁定技，摸牌阶段摸牌时，你额外摸三张牌；你的手牌上限+3。",
