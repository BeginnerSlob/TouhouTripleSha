...
--连舞技：每当你的一个技能发动或触发时，若此时你所有的除了连舞技外的游戏开始时便拥有的技能都已在当前回合内发动或触发，则直到回合结束，你可以发动一次连舞技。连舞技无法被其他角色获得。
	...
	["cv:kami010"]="暂无",
	["thrangdeng"]="禳灯",
	[":thrangdeng"]="锁定技，出牌阶段开始时，你须选择一项：依次将至多三张与你人物牌上的任何一张牌点数都不相同的手牌面朝上置于你的人物牌上，称为“灯”；或弃置一张手牌。你的人物牌上每有一种花色的“灯”，你获得相应的技能：红桃“闭月”；黑桃“霁风”；方块“沉红”；梅花“疾步”。",
	["thrangdengpile"]="灯",
	...
	["cv:kami011"]="暂无",
	["thxujing"]="虚境",
	[":thxujing"]="你的回合外，每当你成为以下牌的目标后，你可以失去一项人物技能并摸一张牌，然后令此牌的使用者获得相应技能，直到你的下一个回合结束：1.黑色非延时类锦囊牌-“幻葬”和“暗月”；2.你的【桃】或【酒】-“霁风”和“隙境”。",
	["thlingyun"]="灵殒",
	...
	["cv:kami012"]="暂无",
	["thwunan"]="五难",
	[":thwunan"]="每当一名其他角色：<br />1. 使用一张【神惠雨降】或【竹曲谜宝】时<br />2. 于濒死状态回复体力后，若其体力值不小于1<br />3. 受到一次火焰伤害后<br />4. 发动【净琉璃镜】使用或打出一张【闪】时<br />5. 使用【杀】对没有手牌的角色造成伤害时<br />你可以回复1点体力，并选择一项：摸一张牌；或弃置该角色的一张牌。",
	["thwunan:draw"]="摸一张牌",
	...
	["cv:kami016"]="暂无",
	["thlijian"]="离剑",
	[":thlijian"]="限定技，准备阶段开始时，你可以展示一张手牌，所有其他角色须依次选择一项：交给你一张与此牌类型相同的牌；或受到你对其造成的1点伤害。",
	["@thlijian-show"]="请展示一张手牌",
	["@thlijian-discard"]="请交给其一张相同类型的牌",
	["thsiqiang"]="死枪",
