...
--连舞技：每当你的一个技能发动或触发时，若此时你所有的除了连舞技外的游戏开始时便拥有的技能都已在当前回合内发动或触发，则直到回合结束，你可以发动一次连舞技。连舞技无法被其他角色获得。
	...
	["cv:kami007"] = "暂无",
	["thfanhun"] = "返魂",
	[":thfanhun"] = "专属技。当你处于濒死状态时，你可获得1枚“绽”标记且体力回复至1点，然后将你的人物牌翻至正面朝上并重置之。",
	["thyoushang"] = "诱殇",
	[":thyoushang"] = "专属技。每当你的非黑桃牌对目标角色造成伤害时，你可以防止此伤害，并令该角色减少1点体力上限，然后获得1枚“绽”标记。",
	["thyouya"] = "幽雅",
	[":thyouya"] = "每当你受到伤害时，你可以弃置一张牌并令一至X名角色选择一项：打出一张【闪】；或令你获得其一张牌。（X为你的“绽”标记的数量）",
	["@thyouya"] = "你可以发动“幽雅”",
	["~thyouya"] = "选择一张牌→选择一至X名角色→点击确定",
	["@thyouya-jink"] = "请打出一张【闪】或点“取消”令 %src 获得一张牌",
	["thmanxiao"] = "满咲",
	[":thmanxiao"] = "锁定技。你每拥有1枚“绽”标记，你的手牌上限便+1。当你拥有4枚“绽”标记时，你立即死亡。",
	["@bloom"] = "绽",
