...
return {
	...
	["@thyouli-hand"] = "受“忧狸”影响，请通过将多余牌置于角色牌上的方法把手牌调整至四张",
	["thjingyuan"] = "惊猿",
...
--连舞技：每当你的一个技能发动或触发时，若此时你所有的除了连舞技外的游戏开始时便拥有的技能都已在当前回合内发动或触发，则直到回合结束，你可以发动一次连舞技。连舞技无法被其他角色获得。
	...
	["cv:kami009"] = "暂无",
	["thyuxin"] = "愈心",
	[":thyuxin"] = "摸牌阶段开始时，你可以放弃摸牌，改为从牌堆顶亮出两张牌并获得之，若这两张牌均为红色，你可以指定一名角色，令其回复1点体力或摸两张牌。",
	["@thyuxin"] = "你可以发动“愈心”",
	["thyuxin-target"] = "你可以指定一名角色，令其回复1点体力或摸两张牌",
	...
	["cv:kami017"] = "暂无",
	["thshuangfeng"] = "霜风",
	[":thshuangfeng"] = "转换技。阶段技。①你可以亮出牌堆顶的X+4张牌（X为“山”标记的数量），将其中一种类别的牌置入弃牌堆，然后将其余的牌置于牌堆底。②你可以随机将弃牌堆里的X+4张牌置入处理区（X为“湖”标记的数量），将其中一种花色的牌置入手牌，然后将其余的牌置于牌堆底。",
	[":thshuangfeng1"] = "阶段技。你可以亮出牌堆顶的X+4张牌（X为“山”标记的数量），将其中一种类别的牌置入弃牌堆，然后将其余的牌置于牌堆底。",
	[":thshuangfeng2"] = "阶段技。你可以随机将弃牌堆里的X+4张牌置入处理区（X为“湖”标记的数量），将其中一种花色的牌置入手牌，然后将其余的牌置于牌堆底。",
	["thxingyong"] = "星涌",
	[":thxingyong"] = "每当你受到1点伤害后，你可获得1枚“山”标记或“湖”标记。",
	["thzaishen"] = "在神",
	[":thzaishen"] = "限定技。一名角色的回合结束时，若牌堆仅剩你置于牌堆底的牌，你可选择一个牌的名称，对其使用牌堆所有该名称的牌（这些牌对其他角色无效）。牌堆洗切时，重置此技能。",
	["@thzaishen-collateral"] = "请选择【断灵御剑】 %src 使用【杀】的目标",
	["@thzaishen-feint-attack"] = "请选择【道忌宣谕】 %src 给牌的目标",
	["@mountain"] = "山",
	["@lake"] = "湖",
