...
return {
	...
	["thlunyu"]="轮狱",
	[":thlunyu"]="连舞技，当一张你不为其使用的目标（或之一）的牌置入弃牌堆时，你将其中一张牌置于牌堆顶，然后此阶段结束时你从牌堆底摸一张牌。",
	["thlunyu:prompt"] = "你可以发动“轮舞”，将 %arg[%arg2] 置于牌堆顶。",
	["thlunyu_obtain:prompt"] = "你是否从弃置的牌中选择一张牌。",
	["#ThLunyuPut"] = "%from 从弃牌堆把 %card 置于牌堆顶。",
