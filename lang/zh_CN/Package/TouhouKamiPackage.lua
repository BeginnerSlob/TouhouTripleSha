...
--连舞技：每当你的一个技能发动或触发时，若此时你所有的除了连舞技外的游戏开始时便拥有的技能都已在当前回合内发动或触发，则直到回合结束，你可以发动一次连舞技。连舞技无法被其他角色获得。
	...
	["cv:kami017"] = "暂无",
	["thshuangfeng"] = "霜风",
	[":thshuangfeng"] = "阶段技。转换技。①你可以亮出牌堆顶的X+4张牌（X为“山”标记的数量），将其中一种类别的牌置入弃牌堆，然后将其余的牌置于牌堆底②你可以随机将弃牌堆里的X+4张牌置入处理区（X为“湖”标记的数量），将其中一种花色的牌置入手牌，然后将其余的牌置于牌堆底。",
	["thxingyong"] = "星涌",
	[":thxingyong"] = "每当你受到1点伤害后，你可选择令“山”标记或“湖”标记的数量+1。",
	["thzaishen"] = "在神",
