...
--连舞技：每当你的一个技能发动或触发时，若此时你所有的除了连舞技外的游戏开始时便拥有的技能都已在当前回合内发动或触发，则直到回合结束，你可以发动一次连舞技。连舞技无法被其他角色获得。
	...
	["cv:kami012"]="暂无",
	["thwunan"]="五难",
	[":thwunan"]="每当一名其他角色：<br />1. 使用一张【神惠雨降】或【竹曲谜宝】时<br />2. 于濒死状态回复体力后，若其体力值不小于1<br />3. 受到一次火焰伤害后<br />4. 发动【净琉璃镜】使用或打出一张【闪】时<br />5. 使用【杀】对没有手牌的角色造成伤害时<br />你可以回复1点体力，你还可以选择一项：摸一张牌；或弃置该角色的一张牌。",
	["thwunan:draw"]="摸一张牌",
