...
--bloom
	...
	["ikdiebei"] = "楪呗",
	[":ikdiebei"] = "锁定技，准备阶段开始时，若你的手牌数不等于你的体力值，你摸两张牌，否则，你须失去1点体力，且跳过你此回合的弃牌阶段。",
...
--luna
	...
	["luna048"] = "月野兔",--月 - 空 - 4血
	["ikzhiwang"] = "织望",
	[":ikzhiwang"] = "锁定技，出牌阶段开始时，你视为对你攻击范围内的一名角色使用一张【杀】。",
	["ikshuluo"] = "帘胧",
	[":ikshuluo"] = "锁定技，若你的手牌数为奇数，你计算与其他角色的距离+1；若你有手牌，且手牌数为偶数，你计算与其他角色的距离-1。",
