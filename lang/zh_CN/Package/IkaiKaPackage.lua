...
--snow
	...
	["ikhuanlue"] = "幻略",
	[":ikhuanlue"] = "出牌阶段限两次，你可以将包含至少一张锦囊牌的两张牌当一张非延时类锦囊牌使用。若你于此阶段至少一次将两张锦囊牌以此法使用，此回合的结束阶段开始时，你摸两张牌。",
	["#ikhuanlue"] = "幻略（摸牌）",
	["ikmuguang"] = "睦广",
...
3.有至少一名黑幕角色已死亡",
	...
	["@zhuxue"] = "朱血",
	["iksheluo"] = "奢罗",
	[":iksheluo"] = "锁定技，专属技，每当你获得一枚“朱血”标记后，根据该标记的数量，你获得相应技能：1枚－“陈情”；4枚－“易境”；7枚－“魂铐”。“终鬼”发动后，每当你以此法获得一项技能后，须失去一项非专属技。牌堆洗切时，你须弃置所有“朱血”标记并失去以此法获得的技能。",
	["ikzhonggui"] = "终鬼",
