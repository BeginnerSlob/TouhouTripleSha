...
--wind
	...
	["ikhunkao"] = "魂铐",
	[":ikhunkao"] = "出牌阶段限两次，你可以展示全部的手牌，并弃置其中一种花色全部的牌，然后你指定至多两名且至多等同于弃置的牌的数量的其他角色，并令她们依次选择一项：交给你一张该花色的牌；或视为你对其使用一张无视距离且不计入使用限制的【杀】。",
	...
	["ikhuangshi"] = "煌矢",
	[":ikhuangshi"] = "出牌阶段开始时，或每当你受到1点伤害后，你可以弃置至多两张手牌，然后令你攻击范围外的一名其他角色弃置等量的牌。",
	["@ikhuangshi"] = "你可以发动“煌矢”",
	...
	["ikxizi"] = "夕紫",
	[":ikxizi"] = "准备阶段开始时，若你有手牌，你可以展示之，并弃置其中一种颜色的所有的牌，然后摸等同于弃置牌数量的牌（至多摸两张）。",
...
--bloom
	...
	["#bloom052"] = "鬼斩的妖剑",
	["bloom052"] = "野井原绯鞠",--花 - 空 - 4血
	["designer:bloom052"] = "殇の腥",
	["illustrator:bloom052"]="かろりー",
	["iklingcha"] = "铭侍",
	[":iklingcha"] = "每当你的【闪】或武器牌置入弃牌堆时，你可以选择一项：摸一张牌；或将该牌交给一名其他角色。",
...
--snow
	...
	["iklinghui"] = "灵绘",
	[":iklinghui"] = "出牌阶段限一次，你可令一名其他角色摸一张牌，然后弃置一张手牌，你可弃置至多三张与该牌颜色相同的手牌，并令等量角色依次摸两张牌。",
	["@iklinghui-discard"] = "请弃置一张手牌",
	["@iklinghui"] = "你可以弃置至多三张颜色相同的手牌，并令等量的角色依次摸两张牌",
	["~iklinghui"] = "选择至多三张颜色相同的手牌→选择等量的角色→点击确定",
