...
--bloom
	...
	["#bloom036"] = "圣银的皇女",
	["bloom036"] = "提亚米莉丝•葛蕾•佛德赛",--花 - 空 - 4血
	["ikqingmu"] = "青幕",
	[":ikqingmu"] = "限定技，出牌阶段，你可以令一名其他角色获得一枚“青火”标记。你计算与拥有“青火”标记的角色的距离时无视除该角色外的其他角色及场上的坐骑牌；你对其使用黑色【杀】在结算后，可以令一名其他角色选择一项：对该角色使用一张无视距离的【杀】，或令你摸一张牌。该角色死亡时，你将场上的“青火”标记转移给一名其他角色。",
	["@qinghuo"] = "青火",
	["@ikqingmu"] = "请选择“青幕”的目标",
	["@ikqingmu-slash"] = "受“青幕”影响，请对 %dest 使用一张无视距离的【杀】，或点“取消”令 %src 摸一张牌",
