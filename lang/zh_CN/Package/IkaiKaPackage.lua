...
--wind
	...
	["ikjilun"] = "极轮",
	[":ikjilun"] = "出牌阶段限一次，你可以弃置一张黑色手牌，并弃置你攻击范围内的一名角色装备区的一张牌，然后视为你对其使用一张不计入使用限制的【杀】，若此【杀】没有造成伤害，该角色获得其之前弃置的装备牌。",
	...
	["ikdongzhao"] = "东照",
	[":ikdongzhao"] = "出牌阶段限一次，你可以失去1点体力，并选择一名其他角色，若如此做，该角色此阶段使用的下一张牌无效，且你此阶段使用的下一张基本牌或非延时类锦囊牌，须无视合法性指定该角色为额外的目标。",
...
--bloom
	...
	["iklingcha"] = "零刹",
	[":iklingcha"] = "出牌阶段限一次，你可以将至少一张手牌当【绯想镜诗】或【杀】使用，若你以此法使用的牌被【三粒天滴】或【闪】抵消时，你摸等量的牌。",
	["#iklingcha"] = "零刹（摸牌）",
	...
	["ikduanni"] = "断逆",
	[":ikduanni"] = "出牌阶段限一次，你可以选择你在其攻击范围内的一名角色区域内的一张牌，令其将此牌当【杀】对你使用，若其体力值大于你，你可以为此【杀】额外指定一个目标。",
	["ikzhangyi"] = "章易",
...
--snow
	...
	["iklinghui"] = "灵绘",
	[":iklinghui"] = "出牌阶段限一次，你可令一名其他角色摸一张牌，然后弃置一张手牌，你可弃置一至三张与该牌颜色相同的手牌，并令等量角色依次摸两张牌。",
	...
	["ikxiaowu"] = "虓武",
	[":ikxiaowu"] = "出牌阶段限一次，你可以将一张黑色非锦囊牌当【枯羽华庭】或方块牌当【春雪幻梦】无视合法性对你使用，然后摸一张牌并选择一名其他角色，若如此做，你无视与该角色的距离，直到回合结束，且视为你对其使用一张无视防具且不计入使用限制的【杀】。",
	["#ikxiaowu"] = "虓武（后续结算）",
	...
	["iklihun"] = "礼魂",
	[":iklihun"] = "出牌阶段限一次，你可以将全部的手牌交给一名手牌数小于你的角色，然后该角色须展示任意数量的手牌，最后你选择一项：获得其展示或未展示的手牌。",
...
3.有至少一名黑幕角色已死亡",
	...
	["ikqianshe"] = "潜慑",
	[":ikqianshe"] = "出牌阶段限一次，你可以指定一名手牌数大于你的角色，然后你与其同时弃置任意张手牌。若你的弃牌数大于该角色，你对其造成1点伤害。",
	["@ikqianshe-discard"] = "请弃置任意张手牌（可以不弃）",
	["@ikqianshe"] = "你可以对 %src 发动“潜慑”",
	["~ikqianshe"] = "选择任意张牌弃置（可不选）→选择当前回合角色→点击确定",
	["ikdaolei"] = "导雷",
	[":ikdaolei"] = "出牌阶段限一次，你可以将一张黑桃牌交给一名手牌数小于你的角色，然后展示其至少一张手牌，若其中有黑桃牌，你获得其除展示牌外的所有手牌。",
