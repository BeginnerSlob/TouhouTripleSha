...
--snow
	...
	["ikfenxun"] = "奋迅",
	[":ikfenxun"] = "出牌阶段限一次，你可以弃置一张牌并指定一名角色，当你计算与该角色的距离时，无视除该角色之外的其他角色及场上的坐骑牌，直到回合结束。若你以此法弃置的牌为基本牌，你此阶段使用的下一张【杀】，在结算后置入弃牌堆时，你可以获得之。",
	...
	["ikhuangpopile"] = "荒破",
	["ikyixiang"] = "佚响",
	[":ikyixiang"] = "锁定技，你对在当前回合内失去过其最后一张手牌的其他角色使用牌时无视距离。",
