...
--wind
	...
	["ikxielun"] = "血轮",
	[":ikxielun"] = "出牌阶段限一次，你可弃置一张红色牌，并对你攻击范围内的一至X名角色各造成1点伤害，然后这些角色各摸一张牌（X为你已损失的体力值）。“九命”发动后，你发动“血轮”时无攻击范围限制。",
	["ikcanyue"] = "残月",
	...
	["ikjuechong"] = "绝冲",
	[":ikjuechong"] = "出牌阶段限一次，你可以进行一次判定，若如此做，你使用点数小于判定牌的【杀】时无距离限制，且你使用点数大于判定牌的【杀】时，令其不计入使用限制，直到回合结束。",
	...
	["ikfanzhong"] = "反塚",
	[":ikfanzhong"] = "出牌阶段限一次，你可以弃置一张牌并指定一名体力值最多（或之一）的角色，你对其造成1点伤害。",
	["ikyuanyuan"] = "元缘",
	[":ikyuanyuan"] = "当你对一名其他角色造成伤害时，你可以防止此伤害，然后获得其装备区或判定区的一张牌。",
	["#IkYuanyuan"] = "%from 发动了“%arg”，防止了对 %to 的伤害",
	
	["#wind050"] = "脉动的龙姬",
	["wind050"] = "提娅•莱特宁格",--风 - 空 - 4血
	["&wind050"] = "提娅",
	["designer:wind050"] = "韩旭",
	["illustrator:wind050"]="カントク",
	["ikwujietiya"] = "舞节",
	[":ikwujietiya"] = "出牌阶段限一次，你可以弃置一张牌，然后令一名其他角色选择一项：将一张牌置于你的人物牌上；或令你弃置其一张牌。当你人物牌上有牌时，你可以将红色牌当【闪】、黑色牌当【三粒天滴】使用或打出。准备阶段开始时，你须获得你人物牌上的全部的牌。",
	...
	["iklinglong"] = "玲珑",
	[":iklinglong"] = "锁定技，若你的装备区没有防具牌，视为你装备着【净琉璃镜】；若你的装备区没有坐骑牌，你的手牌上限+1；若你的装备区没有宝物牌，你视为拥有技能“疾智”。",
...
--bloom
	...
	["ikhuyin"] = "弧音",
	[":ikhuyin"] = "出牌阶段限一次，你可以选择一名其他角色，然后将一张牌面朝上置于你的人物牌上。当该角色使用、打出或弃置与你人物牌上的牌类别相同的牌时，其失去1点体力并获得你人物牌上的牌。准备阶段开始时，你须获得你人物牌上的牌。",
	["@huyin_basic"] = "弧音（基本牌）",
	["@huyin_equip"] = "弧音（装备牌）",
	["@huyin_trick"] = "弧音（锦囊牌）",
	["ikhuyinpile"] = "弧音",
	...
	["illustrator:bloom033"]="茨乃",
	["ikshenyu"] = "神御",
	[":ikshenyu"] = "你的回合结束时，你可以令一至X名其他角色获得一枚“御守”标记。当没有“御守”标记的其他角色计算与拥有“御守”标记的角色的距离时，始终+1，直到你的下一个回合结束（X为存活角色的数量的一半-1，向下取整）。",
	["@yushou"] = "御守",
	["@ikshenyu"] = "你可以发动“神御”",
	["~ikshenyu"] = "选择一至X名其他角色→点击确定",
	...
	["ikbihua"] = "贲华",
	[":ikbihua"] = "每当一名角色成为【杀】的目标后，若你与该角色的距离不大于1，你可以将一张牌交给该角色并令其展示之，若为装备牌，其可使用之，然后你摸一张牌。",
	["@ikbihua-give"] = "请交给 %src 一张牌",
	["ikbihua_use:use"] = "你可以使用该装备牌",
	...
	["iktianyu"] = "天羽",
	[":iktianyu"] = "回合结束时，你可以选择包括你在内的至少两名连续的角色，这些角色（除你外）获得技能“飞影”，直到你的下个回合结束。",
	["@iktianyu"] = "你可以发动“天羽”",
	...
	["iklingxue"] = "淩雪",
	[":iklingxue"] = "每当你受到1点伤害后，你可以令当前回合角色手牌上限-1，直到回合结束。然后若该角色于此回合的弃牌阶段没有弃置牌，你于回合结束时，可以选择一项：获得当前回合角色的一张牌；或摸一张牌。",
	...
	["#bloom050"] = "楚魅的剑姬",
	["bloom050"] = "琪露蒂•夏普",--花 - 空 - 4血
	["&bloom050"] = "琪露蒂",
	["designer:bloom050"] = "韩旭",
	["illustrator:bloom050"]="NAbyssor",
	["ikqingwei"] = "青卫",
	...
	["ikzhiyu"] = "织煜",
	[":ikzhiyu"] = "出牌阶段限一次，你可以失去1点体力，然后选择一项，直到回合结束：<br />1. 你可将一张基本牌当任意基本牌使用或打出；<br />2. 你摸两张牌，且你使用的锦囊牌无距离限制；<br />3. 你摸一张牌，并弃置一张装备牌，然后你使用【杀】指定目标后，你可以弃置其两张牌。",
	...
	["ikchenqing"] = "陈情",
	[":ikchenqing"] = "当一名角色处于濒死状态时，你可以选择另一名其他角色，令该角色摸四张牌，然后其弃置四张牌，若其弃置的四张牌花色各不同，其视为对濒死角色使用【桃】。",
	["@ikchenqing"] = "你可以发动“陈情”",
	["@ikchenqing-discard"] = "请弃置四张牌",
	["ikmojing"] = "默憬",
	[":ikmojing"] = "结束阶段开始时，你可以将一张手牌当你于出牌阶段内使用过的一张非延时类锦囊牌使用，然后你可以将一张手牌当你于出牌阶段内使用过的一张基本牌使用。",
	["@ikmojing_ask_first"] = "你可以将一张手牌当你于出牌阶段内使用过的一张非延时类锦囊牌使用",
	["@ikmojing_ask_second"] = "你可以将一张手牌当你于出牌阶段内使用过的一张基本牌使用",
...
--snow
	...
	["ikhongrou"] = "弘柔",
	[":ikhongrou"] = "出牌阶段限一次，你可弃置一张牌并令一至两名其他角色各摸一张牌。",
	["ikhuaxiao"] = "花咲",
	...
	["iklunke"] = "轮刻",
	[":iklunke"] = "出牌阶段限一次，你可以选择一名人物牌没有横置的其他角色，然后横置该角色和你的人物牌。",
	["ikcangmie"] = "苍灭",
	...
	["ikmumu"] = "穆穆",
	[":ikmumu"] = "若你于出牌阶段内未造成伤害，则此回合的结束阶段开始时，你可以选择一项：弃置场上的一张武器牌，然后摸一张牌；或获得场上的一张防具牌，然后使用之。",
	["@ikmumu"] = "你可以发动“穆穆”",
	...
	["ikyaoyin"] = "妖淫",
	[":ikyaoyin"] = "出牌阶段限一次，你可以弃置X张牌（X为你已损失的体力值），然后令一至X名已受伤的角色各回复1点体力，然后若你以此法弃置的牌中有黑色牌，你须失去1点体力。",
	...
	["ikqingshe"] = "青赦",
	[":ikqingshe"] = "觉醒技，准备阶段开始时，若有至少一名你曾发动“慈雨”令其摸牌的角色已受伤，你增加1点体力上限并回复1点体力，然后获得技能“氷泠”（出牌阶段限一次，你可以令一名其他角色弃置其一个区域里的所有牌并摸等量的牌，若如此做，你的手牌上限-1，直到回合结束。）。",
	["#IkQingsheWake"] = "%from 触发“%arg”觉醒",
	["ikbingling"] = "氷泠",
	[":ikbingling"] = "出牌阶段限一次，你可以令一名其他角色弃置其一个区域里的所有牌并摸等量的牌，若如此做，你的手牌上限-1，直到回合结束。",
	["ikbingling:h"]="手牌",
	["ikbingling:e"]="装备区",
	["ikbingling:j"]="判定区",
...
--luna
	...
	["ikxincao"] = "心操",
	[":ikxincao"] = "出牌阶段限一次，若你有手牌，你可将全部的手牌交给一名其他角色，然后令该角色与由你指定的另一名角色拼点。若如此做，视为拼点赢的角色对没有赢的角色使用一张无视距离的【杀】。",
	...
	["illustrator:luna035"]="マナカッコワライ",
	["iksheqie"] = "蛇切",
	[":iksheqie"] = "出牌阶段限一次，你可以令一名你攻击范围内的角色交给你一张手牌。然后若你的手牌数大于该角色，视为该角色选择对你使用一张无视距离的【杀】或【碎月绮斗】。",
	...
	["ikyishi"] = "片相",
	[":ikyishi"] = "每当一名角色成为【杀】的目标后，若你与此【杀】使用者均与该角色相邻，你可以令该角色弃置一张装备区的牌。",
	
	["#luna050"] = "御灵的魔女",
	["luna050"] = "海棠璃璃子",--月 - 空 - 4血
	["designer:luna050"] = "游卡桌游",
	["illustrator:luna050"]="マナカッコワライ",
	["ikleimai"] = "雷脉",
	...
	["ikcangliu"] = "苍流",
	[":ikcangliu"] = "出牌阶段开始时，你可以展示你的手牌，若其中没有【杀】，则每当你需要使用或打出一张【杀】时，你可以视为使用或打出了一张【杀】，直到你的手牌数变化或一名角色死亡。你每回合只能以此法使用或打出三张【杀】。",
