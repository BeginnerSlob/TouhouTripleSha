...
--wind
	...
	["ikxielun"] = "血轮",
	[":ikxielun"] = "出牌阶段限一次，你可弃置一张红色牌，并对你攻击范围内的至多X名角色各造成1点伤害，然后这些角色各摸一张牌（X为你已损失的体力值）。“九命”发动后，你发动“血轮”时无攻击范围限制。",
	["ikcanyue"] = "残月",
...
--bloom
	...
	["ikzhiyu"] = "织煜",
	[":ikzhiyu"] = "出牌阶段限一次，你可以失去1点体力，并摸一张牌，然后选择一项，直到回合结束：<br />1. 你可将一张基本拍当任意基本牌使用或打出；<br />2. 你摸一张牌，且你使用的锦囊牌无距离限制；<br />3. 你弃置一张装备牌，然后你使用【杀】指定目标后，你可以弃置其两张牌。",
	["ikzhiyu_slash"] = "织煜出杀",
...
--snow
	...
	["ikyaoyin"] = "妖淫",
	[":ikyaoyin"] = "出牌阶段限一次，你可以弃置X张牌（X为你已损失的体力值），然后令至多X名已受伤的角色各回复1点体力，然后若你以此法弃置的牌中有黑色牌，你须失去1点体力。",
