...
return {
	...
	["thgaotian"] = "高天",
	[":thgaotian"] = "每当你需要使用或打出一张【闪】时，你可以观看牌堆顶的X张牌（X为存活角色的数量，且最多为4），你可以至多弃置一张牌并获得其中一张相同颜色的牌，然后将其余的任意数量的牌以任意顺序置于牌堆顶或置入弃牌堆。<br />◆操作提示：发动技能→（若愿意）换牌→双击任意张置入弃牌堆的牌（可跳过）→点“确定”→调整置于牌堆顶的顺序→点“确定”",
