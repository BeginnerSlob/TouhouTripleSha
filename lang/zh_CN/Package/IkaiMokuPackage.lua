...
--wind
	...
	["ikkuanggu"] = "狂骨",
	[":ikkuanggu"] = "锁定技。当你对距离为1以内的一名其他角色造成1点伤害后，你可以回复1点体力或摸一张牌。",
	...
	["ikfuhua"] = "缚华",
	[":ikfuhua"] = "你可以将一张梅花牌当【赤雾锁魂】使用或重铸；当你使用【赤雾锁魂】仅指定一个目标时，你摸一张牌。",
	["#ikfuhua"] = "缚华",
	["iksuinie"] = "碎涅",
	[":iksuinie"] = "限定技。出牌阶段，或当你处于濒死状态时，你可以弃置你判定区里所有的牌，然后将人物牌恢复至游戏开始时的状态，再摸三张牌，最后将体力值回复至3点。",
	...
	["ikfule"] = "福乐",
	[":ikfule"] = "锁定技。当其他角色使用【杀】指定你为目标时，需额外弃置一张基本牌，否则该【杀】对你无效。",
	["@ikfule-discard"] = "你须再弃置一张基本牌使此【杀】生效",
	["ikyouji"] = "攸祭",
	[":ikyouji"] = "专属技。你可以跳过你的出牌阶段，然后在回合结束时可以弃置一张手牌令一名其他角色进行一个额外的回合。",
	["@ikyouji-give"] = "你可以弃置一张手牌令一名其他角色进行一个额外的回合",
	["~ikyouji"] = "选择一张手牌→选择一名其他角色→点击确定",
	["#IkYouji"] = "%to 将进行一个额外的回合",
	["ikruoyu"] = "若愚",
	[":ikruoyu"] = "君主技。觉醒技。准备阶段开始时，若你的体力值是全场最少的（或之一），你须增加1点体力上限，回复1点体力，并获得技能“心契”。",
	["#IkFule"] = "%from 受到“%arg”的影响，需弃置一张基本牌才能令此【杀】对 %to 生效。",
	...
	["ikjugui"] = "巨鬼",
	[":ikjugui"] = "锁定技。【百鬼夜行】对你无效；当其他角色使用的【百鬼夜行】因结算结束而置入弃牌堆时，你获得之。",
	["#sa_avoid_ikjugui"] = "巨鬼",
	["iklieren"] = "烈刃",
...
--bloom
	...
	["ikkujie"] = "枯界",
	[":ikkujie"] = "你可以将一张黑色非锦囊牌当【枯羽华庭】使用。",
	["ikjieying"] = "竭盈",
	[":ikjieying"] = "锁定技。当一名其他角色跳过摸牌阶段后，你摸一张牌；你可以无视距离对手牌数不小于你的角色使用【枯羽华庭】。",
	...
	["ikzhaihun"] = "宅魂",
	[":ikzhaihun"] = "结束阶段开始时，你可以摸1张牌，然后将你的人物牌翻面。",
	["ikfojiao"] = "佛脚",
	[":ikfojiao"] = "当你翻面时，你可以摸一张牌，然后你可以使用一张锦囊牌或装备牌，若如此做，你可以弃置场上与此牌类别相同的一张牌。",
	["@ikfojiao"] = "你可以使用一张锦囊牌或装备牌",
	["@ikfojiao-discard"] = "你可以弃置一名角色场上与你使用的牌同类型的牌",
	...
	["ikrenjia"] = "忍枷",
	[":ikrenjia"] = "锁定技。当你受到伤害后或于弃牌阶段弃置手牌时，获得等同于受到伤害或弃置手牌数量的“桎”标记。",
	["@fetter"] = "桎",
	["iktiangai"] = "天盖",
...
--snow
	...
	["ikyuanjie"] = "缘结",
	[":ikyuanjie"] = "阶段技。你可以选择两名手牌数差不大于三的其他角色，并弃置等同于这两名角色手牌数差的牌，然后交换她们的手牌。",
...
--luna
	...
	["ikhuanshen"] = "幻身",
	[":ikhuanshen"] = "所有人都展示人物牌后，你随机获得三张未加入游戏的人物牌，称为“形”，将其中一张置于你的人物牌上并声明该人物的一项技能，你获得该技能且将特殊属性和势力属性变成与该人物相同直到失去人物牌上的牌。回合开始时和结束后，你可以获得你人物牌上的牌，然后将一张“形”置于你的人物牌上并声明该人物的一项技能（你不可声明限定技、觉醒技、君主技或专属技）。",
	["#ikhuanshen-start"] = "幻身（游戏开始）",
	["#SetIkHuanshen"] = "%from 声明了 %arg 人物牌上的“%arg2”",
	["#GetIkHuanshen"] = "%from 获得了 %arg 张“形”，现在共有 %arg2 张“形”",
	["#GetIkHuanshenDetail"] = "%from 获得了“形” %arg",
	["iklingqi"] = "灵契",
	[":iklingqi"] = "专属技。每当你受到1点伤害后，你可以获得一张“形”。",
	...
	["$IkGuihuo"] = "%from 使用 %card 发动了“%arg2”，声明此牌为 【%arg】，指定的目标为 %to",
	["#IkGuihuoNoTarget"] = "%from 发动了“%arg2”，声明此牌为 【%arg】",
	["$IkGuihuoNoTarget"] = "%from 使用 %card 发动了“%arg2”，声明此牌为 【%arg】",
