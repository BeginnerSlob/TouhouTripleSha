...
--bloom
	...
	["bloom012"] = "伊芙",--花 - 空 - 4血
	["ikqiangxi"] = "强袭",
	[":ikqiangxi"] = "出牌阶段限一次，你可以失去1点体力或弃置一张武器牌，并对你或你攻击范围内的一名角色造成1点伤害。",
...
--snow
	...
	["snow012"] = "伊卡洛斯",--雪 - 空 - 4血
	["ikjianlue"] = "歼略",
	[":ikjianlue"] = "出牌阶段限一次，你可以与一名其他角色拼点。若你赢，你获得技能“空殒”直到回合结束（你于出牌阶段可以额外使用一张【杀】；当你使用【杀】时可以额外指定一个目标，且无距离限制。）；若你没赢，你不能使用【杀】直到回合结束。",
