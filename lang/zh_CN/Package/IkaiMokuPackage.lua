...
--wind
	...
	["ikyouxing"] = "攸幸",
	[":ikyouxing"] = "你可以跳过你的出牌阶段，然后在回合结束时可以弃置一张手牌令一名没有拥有技能“攸幸”的其他角色进行一个额外的回合。",
	["@ikyouxing-give"] = "你可以弃置一张手牌令一名其他角色进行一个额外的回合",
	["~ikyouxing"] = "选择一张手牌→选择一名其他角色→点击确定",
	["#IkYouxing"] = "%to 将进行一个额外的回合",
	["ikmugua"] = "目挂",
	[":ikmugua"] = "主公技，觉醒技，准备阶段开始时，若你的体力值是全场最少的（或之一），你须增加1点体力上限，回复1点体力，并获得技能“心契”。",
...
--snow
	...
	["ikdimeng"] = "缔盟",
	[":ikdimeng"] = "出牌阶段限一次，你可以选择两名手牌数差不大于三的其他角色，并弃置等同于这两名角色手牌数差的牌，然后他们须同时将全部的手牌交给对方。",
