...
return {
	...
	["cv:reihou029"] = "暂无",
	["rhjiyu"] = "觊觎",
	[":rhjiyu"] = "一名角色的回合结束时，若该角色于此回合内对你使用过牌，且若其于此回合内未对你造成过伤害，你可以摸一张牌。",
	...
	["cv:reihou038"] = "暂无",
	["rhshiguang"] = "时光",
	[":rhshiguang"] = "出牌阶段开始时，你可以将“灵宝牌”置入灵宝牌堆并选择一至四项：1、摸一张牌，然后手牌上限-1直到回合结束；2、摸一张牌，然后使用【杀】的次数上限-1；3、摸一张牌，然后失去1点体力；4、摸一张牌，然后将武将牌翻面。",
	["rhkuili"] = "馈礼",
	[":rhkuili"] = "一名角色的回合开始时，你可以令其拥有“时光”。",
