...
return {
	...
	["cv:reihou003"] = "暂无",
	["rhhuanjing"] = "幻境",
	[":rhhuanjing"] = "你获得此技能时，你可以宣言一个基本牌或非延时类锦囊牌的名称，每名角色的回合限一次，你可以弃置一张黑桃牌，视为使用了此牌。",
	["other_trick"] = "其他锦囊",
	...
	["cv:reihou005"] = "暂无",
	["rhliufu"] = "流払",
	[":rhliufu"] = "你成为一张基本牌或非延时锦囊的目标后，可以弃置此灵宝牌并选择一至两项：令此牌对你无效；当此牌因结算结束而置入弃牌堆前，你将之交给一名角色。",
	["#rhliufu"] = "流払（获得）",
	...
	["cv:reihou007"] = "暂无",
	["rhxuesha"] = "血杀",
	[":rhxuesha"] = "锁定技。若你已受伤，其他角色每回合只能对你造成一次伤害；你使用的黑色【杀】无距离限制；红色【杀】不可被闪避。",
