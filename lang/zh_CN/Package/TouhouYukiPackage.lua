...
return {
	...
	["cv:yuki006"] = "暂无",
	["thdunjia"] = "遁甲",
	[":thdunjia"] = "阶段技。你可以将一张装备牌当【心网密葬】使用→当目标因执行此【心网密葬】的效果而失去基本牌后，你摸X张牌（X为你与目标装备区里的牌数的差与2中的较小值）。",
	...
	["cv:yuki010"] = "暂无",
	["thhanpo"] = "寒魄",
	[":thhanpo"] = "出牌阶段开始时，你可以选择一名其他角色→此阶段结束时，若其于此阶段内失去过至少两张牌，其将人物牌翻面，然后摸两张牌。",
	["@thhanpo"] = "你可以发动“寒魄”",
	["#thhanpo"] = "寒魄",
	["thbingpu"] = "氷瀑",
	[":thbingpu"] = "限定技。出牌阶段，你可以选择所有有牌的其他角色▶这些角色各：需打出【闪】，否则你依次弃置其两张牌。",
	...
	["cv:yuki014"] = "暂无",
	["thqiebao"] = "窃宝",
	[":thqiebao"] = "①当一名角色对另一名角色使用【桃】时，你可以弃置一张【杀】▶令此【桃】对使用者以外的目标无效，若此【杀】为红色，你获取此【桃】。②当一名角色得到另一名角色的牌前，你可以弃置一张【杀】▶你获取这些牌。",
