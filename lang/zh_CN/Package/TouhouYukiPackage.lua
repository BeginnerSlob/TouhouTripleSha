...
return {
	...
	["cv:yuki006"] = "暂无",
	["thdunjia"] = "遁甲",
	[":thdunjia"] = "出牌阶段限三次，你可以将一张装备牌或【杀】当【心网密葬】使用；若该角色被此牌所弃置的牌为【闪】，你对其造成1点伤害。",
	...
	["cv:yuki018"] = "暂无",
	["thlingdie"] = "灵蝶",
	[":thlingdie"] = "出牌阶段限两次，你可以将一张手牌交给一名其他角色，然后令该角色观看由其选择的另一名角色的手牌。若你以此法交给的手牌为红桃，该角色摸一张牌；若不为红桃，你此阶段不可以再发动“灵蝶”",
