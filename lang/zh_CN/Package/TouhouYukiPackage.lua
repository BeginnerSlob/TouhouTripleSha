...
return {
	...
	["thzhanshi"]="占筮",
	[":thzhanshi"]="锁定技，出牌阶段结束时，若你在此阶段使用的牌不少于三张，且全部发动了“筹策”，你在此回合结束后进行一个额外的回合，且于额外回合的回合开始时获得技能“幻葬”直到回合结束（锁定技，出牌阶段结束时，你进行一次判定，若结果为黑桃，你失去1点体力）。",
	["#thzhanshi"]="占筮（进行额外回合）",
	["@tianji"]="天机",
	["thhuanzang"]="幻葬",
	[":thhuanzang"]="锁定技，出牌阶段结束时，你进行一次判定，若结果为黑桃，你失去1点体力",
