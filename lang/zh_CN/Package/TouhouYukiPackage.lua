...
return {
	...
	["cv:yuki005"]="暂无",
	["thmoji"]="墨迹",
	[":thmoji"]="当你需要使用或打出一张基本牌时，若你的体力值大于1，你可以将两张手牌以任意顺序置于牌堆顶；否则你可以将一张手牌置于牌堆顶。若如此做，视为你使用或打出一张该基本牌。<br/><font color=blue>★你选择的牌将以你选择的顺序的逆序置于牌堆顶</font>",
	["thmoji_slash"]="墨迹出杀",
	["thmoji_saveself"]="墨迹自救",
	["thyuanqi"]="缘起",
	[":thyuanqi"]="出牌阶段限一次，你可以展示一张手牌并亮出牌堆顶的一张牌，若这两张牌颜色相同，你选择一项：将这些牌置入弃牌堆，然后回复1点体力；或将这些牌交给一名角色。",
	...
	["cv:yuki006"]="暂无",
	["thdunjia"]="遁甲",
	[":thdunjia"]="出牌阶段限三次，你可以将一张【杀】当【心网密葬】使用；若该角色被此牌所弃置的牌为【闪】，你对其造成1点伤害。",
	...
	["thzhengguan"]="争冠",
	[":thzhengguan"]="每当一名其他角色跳过摸牌阶段后，你可以摸两张牌；每当一名其他角色跳过出牌阶段后，你可以无视距离对一名其他角色使用一张【杀】。",
	["@thzhengguan"]="你可以发动“争冠”无视距离对一名其他角色使用一张【杀】",
	["thbingpu"]="氷瀑",
	...
	["cv:yuki011"]="暂无",
	["thdongmo"]="冬末",
	[":thdongmo"]="结束阶段开始时，你可以指定一至X名其他角色（X为你已损失的体力值），你和这些角色将各自的武人物翻面，并各摸一张牌。",
	["@thdongmo"]="你可以发动“冬末”",
	...
	["cv:yuki016"]="暂无",
	["thkujie"]="苦戒",
	[":thkujie"]="其他角色的出牌阶段限一次，该角色可以弃置一张红色基本牌，然后令你失去1点体力，若如此做，此回合结束后，你回复2点体力，并令一名角色摸一张牌。",
	["thkujiev"]="苦戒",
	[":thkujiev"]="出牌阶段限一次，若云居一轮在你攻击范围内，你可以弃置一张红色基本牌，然后令云居一轮失去1点体力，若如此做，此回合结束后，云居一轮回复2点体力。",
	["#thkujie-recover"]="苦戒（回复体力）",
	["thyinbi"]="廕庇",
	[":thyinbi"]="当一名体力值不大于你的其他角色因伤害而扣减体力后，你可以令其回复等量的体力，然后伤害来源对你造成等量的同属性伤害。",
	...
	["thchuanshang"]="船殇",
	[":thchuanshang"]="出牌阶段限一次，你可以令你攻击范围内的一名角色获得1枚“溺水”标记，若其已拥有该标记，你失去1点体力。其他角色每拥有1枚该标记，其手牌上限便-1。其他角色的结束阶段开始时，若其拥有1枚或更多的“溺水”标记，须进行一次判定，若为红桃，弃置2枚该标记；若为黑色，获得1枚该标记。",
	["@nishui"]="溺水",
	...
	["cv:yuki018"]="暂无",
	["thlingdie"]="灵蝶",
	[":thlingdie"]="出牌阶段限三次，你可以将一张手牌交给一名其他角色，然后令该角色观看由其选择的另一名角色的手牌；或摸一张牌。若你以此法交给的手牌不为红桃，你此阶段不可以再发动“灵蝶”。",
	["@thlingdie"]="请选择令其观看手牌的角色，或点“取消”令其摸一张牌",
	["thwushou"]="无寿",
	[":thwushou"]="每当你受到一次伤害后，你可以将你的手牌补至四张。",
	["thfuyue"]="浮月",
	[":thfuyue"]="君主技，其他雪势力角色的出牌阶段限一次，若你的体力值为1，可以与你拼点，若该角色没有赢，你回复1点体力。你可以拒绝此拼点。",
	["thfuyuev"]="浮月",
	[":thfuyuev"]="出牌阶段限一次，若你为雪势力且君主的体力值为1，你可以与君主拼点，若你没赢，君主回复1点体力。君主可以拒绝此拼点。",
	["thfuyuev:accept"]="同意此次拼点",
	["thfuyuev:reject"]="拒绝此次拼点",
}