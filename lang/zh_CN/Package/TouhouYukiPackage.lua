...
return {
	...
	["@thdunjia"] = "你可以发动“遁甲”",
	["thqingming"] = "晴明",
	[":thqingming"] = "当你使用【杀】指定一名其他角色后，若其装备区的牌比你多，你可以取消之并视对其使用一张【木隐妖岚】、【妙手探云】、【心网密葬】或【碎月绮斗】。",
	["@thqingming"] = "你可以发动“晴明”",
	...
	["cv:yuki010"] = "暂无",
	["thjidong"] = "急冻",
	[":thjidong"] = "锁定技。防止你对其他角色造成的火焰伤害，防止你受到的火焰伤害。",
	["thhanpo"] = "寒魄",
	[":thhanpo"] = "出牌阶段开始时，你可以令一名其他角色摸等同于场上方块牌数的牌，然后弃置等量的牌。若如此做，此阶段结束时，若其于此阶段内失去过至少两张牌，其将人物牌翻面，然后摸一张牌。",
	["@thhanpo"] = "你可以发动“寒魄”",
	["thbingpu"] = "氷瀑",
