...
return {
	...
	["thheimu"] = "黑幕",
	[":thheimu"] = "阶段技。当你使用一张牌指定目标时，你可以令一名其他角色成为此牌的使用者。",
	["@thheimu"] = "你可以发动“黑幕”",
	...
	["thchuanshang"] = "船殇",
	[":thchuanshang"] = "阶段技。你可以令你攻击范围内的一名角色获得1枚“溺水”标记，若其已拥有该标记，你失去1点体力。其他角色每拥有1枚该标记，其手牌上限便-1。其他角色的结束阶段开始时，若其拥有1枚或更多的“溺水”标记，须进行一次判定，若为红桃，弃置2枚该标记；若为黑色，获得1枚该标记。",
	["@drowning"] = "溺",
