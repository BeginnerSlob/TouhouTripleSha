...
return {
	...
	["cv:bangai008"] = "暂无",
	["thyubo"] = "羽帛",
	[":thyubo"] = "阶段技。你可以弃置一张黑色手牌并将一至两名角色的人物牌横置。",
	["thqiongfa"] = "穹法",
	...
	["cv:bangai012"] = "暂无",
	["thkongxiang"] = "空象",
	[":thkongxiang"] = "出牌阶段，你可以选择一项：<br />1. 弃置两张黑桃牌并令一名角色回复1点体力。<br />2. 弃置两张方块牌并弃置至多两名其他角色区域的各一张牌；<br />3. 弃置两张梅花牌并令一名其他角色摸两张牌；<br />4. 弃置两张红桃牌并令一名其他角色摸一张牌，然后弃置一张手牌，最后该角色将其人物牌翻面。",
}