...
return {
	...
	["cv:bangai002"] = "暂无",
	["thshoujuan"] = "授卷",
	[":thshoujuan"] = "你的回合内，每当其他角色失去牌后，你可以令其摸两张牌，每回合限三次。",
	["thmiqi"] = "谧契",
	...
	["@thzhongjie"] = "你可以发动“忠节”",
	["thxumei"] = "虚魅",
	[":thxumei"] = "出牌阶段限一次，你可以弃置一张基本牌并亮出牌堆顶的三张牌，然后令一名角色获得其中一种类别的牌，将其余的牌置入弃牌堆。若如此做，该角色不能使用或打出该类别的牌，直到回合结束。",
	...
	["@thqinshao"] = "你可以发动“琴韶”",
	["thxingxie"] = "星屑",
	[":thxingxie"] = "出牌阶段限一次，你可以弃置一张手牌，然后将一名角色装备区内的全部牌置于你的人物牌上，此回合结束时，令其依次获得并使用这些牌。",
	["thxingxiepile"] = "星屑",
	...
	["cv:bangai008"] = "暂无",
	["thyubo"] = "羽帛",
	[":thyubo"] = "出牌阶段限一次，你可以弃置一张黑色手牌并将一至两名角色的人物牌横置。",
	["thqiongfa"] = "穹法",
	...
	["cv:bangai012"]="暂无",
	["thsixiang"]="四象",
	[":thsixiang"]="出牌阶段，你可以选择一项：<br />1. 弃置两张黑桃牌并回复1点体力。<br />2. 弃置两张方块牌并弃置一名其他角色区域的一张牌。<br />3. 弃置两张梅花牌并令一名其他角色摸两张牌，然后该角色须弃置一张牌。<br />4. 弃置两张红桃牌并令一名其他角色摸一张牌，然后该角色将其人物牌翻面。结束阶段开始时，你摸X张牌（X为你此回合发动该技能的次数-1）。",
	["#thsixiang-draw"]="四象（摸牌）",
}