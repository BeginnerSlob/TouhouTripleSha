...
return {
	...
	["cv:bangai005"] = "暂无",
	["thmengwei"] = "梦违",
	[":thmengwei"] = "当一名角色的手牌被展示后，你可以摸一张牌。每回合限一次。",
	["thxijing"] = "隙境",
	[":thxijing"] = "当一名角色的判定牌生效前，你可以令该角色展示手牌，然后你选择打出其中的一张牌代替之。每回合限一次。",
	...
	["@thqinshao"] = "你可以发动“琴韶”",
	["thxingxie"] = "星屑",
	[":thxingxie"] = "阶段技。你可以弃置一张手牌，然后将一名角色装备区内的全部牌称为“璨”置于你的人物牌上，此回合结束时，其获取所有“璨”并依次使用这些牌。",
	...
	["thwangdao"] = "妄道",
	[":thwangdao"] = "出牌阶段，你可以选择一名其他角色并展示一张【桃】，该角色须选择一项：1.对你使用一张与此【桃】花色相同的无视距离的【杀】；2.令你弃置此【桃】，然后令你选择弃置其两张牌或令其失去1点体力。",
