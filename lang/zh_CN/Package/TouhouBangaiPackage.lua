...
return {
	...
	["designer:bangai001"] = "桃花僧",
	["illustrator:bangai001"] = "安威拓郎",
	["cv:bangai001"] = "暂无",
	["thbianfang"] = "辨方", 
	[":thbianfang"] = "每当你使用【杀】对一名其他角色造成一次伤害后，或一名其他角色使用一张【杀】对你造成一次伤害后，你可以进行Ｘ次判定，每有一张判定牌花色与该【杀】相同，你便可以获得该角色的一张牌（Ｘ为你已损失的体力值，且至少为１）。",
	...
	["designer:bangai009"] = "桃花僧",
	["illustrator:bangai009"] = "藤原",
	["cv:bangai009"] = "暂无",
	["thweide"] = "威德",
	[":thweide"] = "摸牌阶段结束时，你可以将你于此阶段所摸的牌交给一名其他角色，然后若你已受伤，你可以获得一名其他角色区域内的一张牌。",
	["@thweide"] = "你可以发动“威德”",
	["#thweide"] = "威德（后续结算）",
