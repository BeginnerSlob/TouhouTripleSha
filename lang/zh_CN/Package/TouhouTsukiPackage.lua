...
return {
	...
	["thyejunv"] = "夜君",
	[":thyejunv"] = "出牌阶段限一次，若场上所有角色的人物牌都竖置且你为月势力角色，你可以横置君主的人物牌。",
	...
	["cv:tsuki002"] = "暂无",
	["thjinguo"] = "禁果",
	[":thjinguo"] = "出牌阶段限一次，你可以选择一项：<br />1. 弃置一张红桃手牌并获得一名其他角色的两张牌（不足则全部获得），然后该角色选择回复1点体力；或摸一张牌；<br />2. 获得技能“血呓”直到回合结束（你可以将红桃非锦囊牌当【春雪幻梦】使用。）。",
