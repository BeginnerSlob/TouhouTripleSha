...
return {
	...
	["@thchenji"]="你可以发动“沉寂”",
	["thkuangxiang"]="狂想",
	[":thkuangxiang"]="当人物牌横置的角色被选择为基本牌或非延时类锦囊牌的目标后，若你不为其目标，你可无视合法性成为该牌的目标；当你被选择为基本牌或非延时类锦囊牌的目标后，你可以令所有人物牌横置的不为其目标的角色都无视合法性成为该牌的目标。在结算后，将这些角色的人物牌重置。",
	...
	["cv:tsuki016"]="暂无",
	["thshenyou"]="神佑",
	[":thshenyou"]="摸牌阶段开始时，你可放弃摸牌，改为获得一名其他角色区域内的一张牌，然后你可以对该角色使用一张无视距离的【杀】，你可以令此【杀】对目标角色即将造成的伤害视为失去体力。",
