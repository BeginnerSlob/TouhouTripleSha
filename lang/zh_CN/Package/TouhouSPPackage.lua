...
return {
	...
	["@thkongsuo"] = "你可以发动“空锁”",
	["thguimen"] = "鬼门",
	[":thguimen"] = "锁定技。当你计算与人物牌横置的角色的距离、人物牌横置的角色计算与你的距离时，无视你们之外的其他角色。",
	["thliuren"] = "六壬",
	...
	["cv:sp008"] = "暂无",
	["thhuanlong"] = "幻胧",
	[":thhuanlong"] = "出牌阶段开始时，你可以选择一至三项：你于此回合内：1.攻击范围+1；2.出牌阶段可以额外使用一张【杀】；3.可以将两张手牌当【杀】使用或打出。若你至少选择两项，你的手牌上限-2，直到回合结束。",
	...
	["thshushu"] = "数术",
	[":thshushu"] = "每当你距离2以内的一名角色成为一张基本牌或黑色非延时类锦囊牌的目标时，你可以用任意张点数的和与之相同的牌替换之。",
	["@thshushu"] = "你可以发动“数术”",
	...
	["thxuyou"] = "虚遊",
	[":thxuyou"] = "阶段技。你使用【杀】时可以无视合法性指定一名角色为目标，若该【杀】没有造成伤害，你依次弃置所有与你相邻的角色的一张牌；当该【杀】造成一次伤害后，你摸一张牌。",
	...
	["sp017"] = "SP古明地觉",--风 - 空 - 4血
	["designer:sp017"] = "未知",
	["illustrator:sp017"] = "未知",
	["cv:sp017"] = "暂无",
	["thhuanling"] = "唤灵",
	[":thhuanling"] = "当其他角色死亡后，你可以摸两张牌▶你获得下列技能中的一项技能——〖赤莲〗、〖魅影〗、〖境穆〗。",
	["thyoukong"] = "游空",
	[":thyoukong"] = "锁定技。你到其他角色的距离-X（X为幻属性角色数）。",

	["#sp018"] = "未知",
	["sp018"] = "SP丰聪耳神子",--花 - 空 - 3血
	["designer:sp018"] = "未知",
	["illustrator:sp018"] = "未知",
	["cv:sp018"] = "暂无",
	["thguanzhi"] = "纶旨",
	[":thguanzhi"] = "结束阶段开始时，你可以弃置攻击范围内含有主公的一名其他角色的一张牌，令其摸一张牌，然后若其手牌比主公角色多，你摸一张牌。",
	["@thguanzhi"] = "你可以发动〖纶旨〗弃置攻击范围有主公的其他角色的牌",
	["thfuhua"] = "抚华",
	[":thfuhua"] = "当你受到其他角色造成的伤害时，你可选择你的任意数量的牌令该角色观看，然后该角色选择一项：1.获得这些牌中的一张，然后防止此伤害。2.弃置等量的牌。你对一名角色只能发动一次“抚华”。<br />※操作:伤害来源需要选择确定来进行弃牌 ",
