...
return {
	...
	["cv:sp005"]="暂无",
	["thwanling"]="万灵",
	[":thwanling"]="你攻击范围内的角色使用的红色【杀】或红色非延时类锦囊牌，在结算后置入弃牌堆时，你可以进行一次判定，若结果不为红桃，你选择一项：令该角色摸一张牌；或弃置一张牌并获得该角色所使用的牌。",
	["@thwanling"]="你可以弃置一张牌获得该牌，或点“取消”令 %src 摸一张牌",
	["thzuibu"]="醉步",
	[":thzuibu"]="每当你受到伤害时，若非【百鬼夜行】造成的伤害，你可以摸一张牌，然后伤害来源也可以摸一张牌并令此伤害-1。",
