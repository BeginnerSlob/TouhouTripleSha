...
return {
	...
	["cv:sp008"]="暂无",
	["thhuanlong"]="幻胧",
	[":thhuanlong"]="出牌阶段开始时，你可以选择一至三项：你于此回合内：1.攻击范围+1；2.出牌阶段可以额外使用一张【杀】；3.可以将两张手牌当【杀】使用或打出。你每选择一项，你的手牌上限便-1，直到回合结束。",
	...
	["@thtianqi"] = "你可以弃置至少一张手牌对 %src 发动“天启”",
	["thlinyao"] = "凛要",
	...
	["thjingyuansp"] = "镜缘",
	[":thjingyuansp"] = "出牌阶段限一次，你可以弃置一张基本牌，然后令装备区里有牌的一至两名角色各选择一项：将其装备区里的一张牌交给除其以外的一名角色；或令你获得其一张手牌。",
