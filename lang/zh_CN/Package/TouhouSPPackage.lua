...
return {
	...
	["cv:sp008"] = "暂无",
	["thhuanlong"] = "幻胧",
	[":thhuanlong"] = "出牌阶段开始时，你可以：选择一项：1.你的攻击范围于此回合内+1；2.你于出牌阶段内使用【杀】的次数上限+1；3.你于此回合内可以将两张手牌当【杀】使用或打出。▶你的手牌上限于此回合内-1，若你的手牌上限不为0，你可以重复此流程。",
	...
	["cv:sp013"] = "暂无",
	["thyimeng"] = "抑梦",
	[":thyimeng"] = "当一名其他角色对你或你相邻的角色造成伤害后，你可以获取该角色的一张手牌▶令其摸一张牌。",
	["thxuyou"] = "虚遊",
	[":thxuyou"] = "阶段技。你可以对一名角色使用跳过合法性检测的【杀】（无距离限制和他我限制）→当此【杀】造成伤害后，你摸一张牌；当此【杀】结算结束后，若此【杀】未造成过伤害，你依次弃置所有你相邻的角色的各一张牌。",
	...
	["cv:sp018"] = "暂无",
	["thguanzhi"] = "纶旨",
	[":thguanzhi"] = "结束阶段开始时，你可以弃置至少一名攻击范围内含有君主的其他角色的各一张牌▶你令这些角色各摸一张牌，然后若这些角色中有手牌多于君主的角色，你摸一张牌。",
	["@thguanzhi"] = "你可以发动“纶旨”",
	["~thguanzhi"] = "选择至少一名角色→点击确定",
	["thfuhua"] = "抚华",
	[":thfuhua"] = "当你受到其他角色造成的伤害时，你可以令来源观看至少一张牌▶其选择一项：1.获取这些牌中的一张牌▶防止此伤害。2.弃置等量的牌。若如此做，其不是你发动〖<b>抚华</b>〗的合法目标。<br />※操作:伤害来源需要点击确定来进行弃牌",
