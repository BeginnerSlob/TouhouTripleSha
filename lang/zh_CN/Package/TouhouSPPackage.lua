...
return {
	...
	["cv:sp005"]="暂无",
	["thwanling"]="万灵",
	[":thwanling"]="其他角色使用的红色【杀】或红色非延时类锦囊牌，在结算后置入弃牌堆时，你可进行一次判定，若结果不为红桃，你选择一项：令该角色摸一张牌；或弃置一张手牌并获得该角色所使用的牌。",
	["@thwanling"]="你可以弃置一张手牌获得该牌，或点“取消”令 %src 摸一张牌",
	["thzuibu"]="醉步",
	...
	["thshushu"] = "数术",
	[":thshushu"] = "每当你成为一张除【绯想镜诗】外的基本牌或非延时类锦囊牌的目标时，你可以用任意张点数的和与之相同的牌替换之。",
	["@thshushu"] = "你可以发动“数术”",
	["~thshushu"] = "选择若干张牌→点击“确定”",
	["$ThShushu"] = "%from 发动“%arg”将 %card 置于桌面",
	["thfengling"] = "封凌",
	[":thfengling"] = "限定技，当你进入濒死状态时，你可亮出牌堆顶的X张牌（X为存活角色的数量，且至少为4），然后可重复以下流程：弃置其中任意张点数和为9的牌并回复1点体力。最后获得其余的牌。",
