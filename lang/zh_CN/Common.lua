return {
	...
	["#ZeroDamage"] = "%from 对 %to 造成的此次伤害减至 0 或更低，防止了此次伤害。",
	["#Recover"] = "%from 恢复了 %arg 点体力",
	["#AskForPeaches"] = "%from 向 %to 求桃，一共需要 %arg 个桃子",
	["#ChooseKingdom"] = "%from 选择了 %arg 作为他的国籍",
	["#NullificationDetails"] = "无懈的对象是 %from 对 %to 使用的锦囊 %arg",
	["#SkillAvoid"] = "这张 %arg2 受到 %from 的 %arg 技能的影响，不能指定其作为目标",
	["#Transfigure"] = "%from 变身为 %arg",
	["#AcquireSkill"] = "%from 获得了技能 【%arg】",
	["#LoseSkill"] = "%from 失去了技能 【%arg】",
	["$InitialJudge"] = "%from 亮出的判定牌为 %card",
	["$ChangedJudge"] = "%from 把 %to 的判定牌改判成了 %card",
	...
	["#DelayedTrick"] = "%from 的延时类锦囊【%arg】开始判定",
