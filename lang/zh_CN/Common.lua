CommonTranslationTable = {
	...
	["$ShowAllCards"] = "%from 展示了全部手牌 %card",
	["$ViewAllCards"] = "%from 观看了 %to 的全部手牌 %card",
