...
return {
	...
	["cv:kami001"]="暂无",
	["thkexing"]="客星",
	[":thkexing"]="回合开始阶段开始时，你可以从牌堆顶亮出Ｘ张牌（Ｘ为存活角色数量的一半，向上取整且至多为４），将其中任意数量的非锦囊牌以任意顺序置于牌堆底，然后将其余的牌置入弃牌堆。",
...
“浓雾”：所有角色每使用【杀】对与其距离1以内的角色造成一次伤害后，回复1点体力。",
	...
	["thchuling"]="初灵",
	[":thchuling"]="觉醒技，回合开始阶段开始时，若你的“玉”的数量为奇数且不小于七张，你须减少1点体力上限，并获得技能“幻君”（锁定技，回合开始阶段开始时，若你的红色“玉”的数量大于黑色，你获得1枚“炎杀”标记；若你的黑色“玉”的数量大于红色，你获得1枚“贤月”标记；否则，你获得1枚“灵殒”标记。当你拥有相应标记时，你可以弃置一张“玉”以发动一项技能：“炎杀”：“凤翔”或“快晴”；“贤月”：“永夜”或“世明”；“灵殒”：“缄魔”或“绮想”。回合开始时，你须弃置全部的“炎杀”、“贤月”或“灵殒”标记。）。",
	...
	["thhuangyi"]="皇仪",
	[":thhuangyi"]="觉醒技，“千狱”发动后，回合开始阶段开始时，若你的体力上限大于X，你须将体力上限减少至X并摸等同于减少数量的牌，然后回复1点体力并失去技能“狂魔”（X为你游戏开始时的体力上限）。",
	["@huangyi"]="皇仪",
...
你可以弃置一张手牌，然后回复1点体力并弃置该角色的一张手牌。",
	...
	["cv:kami015"]="暂无",
	["thzhizun"]="至尊",
	[":thzhizun"]="回合结束阶段开始时，你可选择一项：改变一名其他角色的势力属性；或获得一项技能（你只可以以此法获得“励气”、“唤卫”、“济援”、“御姬”、“祈愿”、“颂威”、“春度”或“舞华”，你不能以此法获得场上其他存活角色拥有的技能）。",
	...
	["cv:kami016"]="暂无",
	["thlijian"]="离剑",
	[":thlijian"]="限定技，回合开始阶段开始时，你可以展示一张手牌，所有其他角色须各选择一项：弃置一张与此牌类型相同的牌；或受到你对其造成的1点伤害。你的下一个回合开始阶段开始时，须重复一次此流程。",
