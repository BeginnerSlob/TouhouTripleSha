...
--爱宕
	...
	["jnyanwang"] = "烟惘",
	[":jnyanwang"] = "觉醒技，你发动\"<b>零刹</b>\"，在结算后，若存活角色数小于你的当前体力值，你须减少1点体力上限。然后其技能\"<b>零刹</b>\"改为出牌阶段限两次，且可以以此法当【心网密葬】使用。",
	
--弥生
	["jnxianmao"] = "贤卯",
	[":jnxianmao"] = "限定技，一名其他角色的回合结束后，若其在该回合对你造成过伤害，你可以将人物牌翻面并进行一个额外的回合，在此额外的回合内，弥生使用的牌须无视合理性指定该角色为目标。",
...
--赤城
	...
	["jnlinglie"] = "零烈",
	[":jnlinglie"] = "觉醒技，准备阶段开始时，若你的体力值不大于3，须减少3点体力上限，体力回复至3点，其技能\"<b>苍流</b>\"中失去效果时机由\"<b>手牌数变化时</b>\"改为\"<b>手牌数增加时</b>\"。",
