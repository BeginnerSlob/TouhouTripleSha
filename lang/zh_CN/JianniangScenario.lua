...
--伊十九
	["jnhuoji"] = "火给",
	[":jnhuoji"] = "出牌阶段限一次，若你人物牌上的牌小于三张，你可以将一张基本牌置于人物牌上。每当你需要使用或打出一张基本牌时，你可以将人物牌上的一张牌置入弃牌堆，视为使用了一张该基本牌，然后摸一张牌。",
	["jnhuojipile"] = "火给",

	["jnniying"] = "匿影",
	[":jnniying"] = "锁定技，游戏开始时，你获得1枚“潜航”标记。拥有该标记时，其他角色对你使用、你对其他角色使用除【百鬼夜行】、【魔闪花火】、【神惠雨降】、【竹取谜宝】或【荒波暴流】外的牌均无效。结束阶段开始时，你须弃置全部该标记。",

	["jntaoxi"] = "涛袭",
	[":jntaoxi"] = "回合结束时，你可以弃置其人物牌上的等同于你体力值的牌，并获得1枚“潜航”标记。一名角色的出牌阶段开始时，你可以弃置全部的该标记，然后若当前回合角色手牌数大于你，你可以对其发动“<b>潜慑</b>”，若小于你，你可以对其发动“<b>导雷</b>”。",
}
