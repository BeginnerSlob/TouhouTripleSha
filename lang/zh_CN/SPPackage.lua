...
return {
	...
	["thqimen"] = "奇门",
	[":thqimen"] = "锁定技，当你计算与武将牌横置的角色的距离、武将牌横置的角色计算与你的距离时，无视你们之外的其他角色。",
	["thguanjia"] = "贯甲",
	...
	["cv:sp006"]="暂无",
	["thmodao"]="魔盗",
	[":thmodao"]="摸牌阶段开始时，你可以放弃摸牌，并选择你攻击范围内的一名其他角色，交换你与其一个区域中的所有牌，然后你与该角色各摸一张牌。",
	...
	["cv:sp007"]="暂无",
	["thmengsheng"]="梦生",
	[":thmengsheng"]="每当你受到一次伤害后，你可以获得伤害来源的一张手牌，然后该角色失去当前的所有武将技能直到你的下一个回合结束。",
	["@mengsheng"]="梦生",
	["thqixiang"]="绮想",
