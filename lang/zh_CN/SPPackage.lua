...
return {
	...
	["cv:sp004"] = "暂无",
	["thchuangshi"] = "创史",
	[":thchuangshi"] = "当其他角色使用【过河拆桥】、【借刀杀人】或【决斗】指定你攻击范围内的一名角色为目标后，你可以抵消该锦囊牌的效果并视为使用锦囊牌的角色对你使用了一张【杀】（此【杀】不计入每阶段的使用限制）。",
	["thgaotian"] = "高天",
	[":thgaotian"] = "每当你需要使用或打出一张【闪】时，你可观看牌堆顶的X张牌并获得其中至多一张红色牌（X为存活角色的数量，且至多为4），将其余的任意数量的牌以任意顺序置于牌堆顶或置入弃牌堆。",
	["thgaotian:get"] = "获得",
