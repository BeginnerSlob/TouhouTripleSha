...
public:
    TaichenFight()
        : ZeroCardViewAsSkill("taichenfight")
    {
    }
...
public:
    ...
    virtual bool trigger(TriggerEvent triggerEvent, Room *room, ServerPlayer *player, QVariant &data) const
    {
        ...
        case BuryVictim: {
            ...
            if (player->getGeneralName() == "sp_pangde" && death.damage && death.damage->from && death.damage->from->isLord()) {
                death.damage = NULL;
...
public:
    CaorenMaxCards()
        : MaxCardsSkill("#caoren-max-cards")
    {
    }
    ...
    : Scenario("fancheng")
{
    ...
    skills << new Guagu << new Dujiang << new Flood << new TaichenFight << new Xiansheng << new Zhiyuan << new CaorenMaxCards;
