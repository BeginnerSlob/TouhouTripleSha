...
public:
    ...
    void setPlayerHuyin(ServerPlayer *player, const QString &name);
    ...
    bool askForYumeng(ServerPlayer *player, QList<int> &cards, const QString &skill_name = QString(),
    ...
    virtual void updateCardsOnMoving(const CardsMoveStruct &move);
