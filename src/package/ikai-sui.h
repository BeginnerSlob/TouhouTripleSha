...
class IkZongtiCard : public SkillCard
{
    Q_OBJECT

public:
    Q_INVOKABLE IkZongtiCard();
...
public:
    IkChenyan();
    virtual QStringList triggerable(TriggerEvent triggerEvent, Room *room, ServerPlayer *yuanshu, QVariant &data,
                                    ServerPlayer *&) const;
