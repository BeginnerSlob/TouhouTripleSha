...
version = "TouhouTripleSha AI 20160224 (V0.26)"
	...
	elseif triggerEvent == sgs.Damaged then
		...
		if not damage.card then
			...
			if sgs.ai_quhu_effect then
				...
				intention = 80
				from = xunyu
			elseif from and (from:hasFlag("ShenfenUsing") or from:hasFlag("FenchengUsing")) or damage.reason == "zhendu" or damage.reason == "thfeiman" then
				intention = 0
			else
				intention = 100
			end
